...
<div id="content" class="page-body">
	...
	<div class="container">
			...
			<div class="col-sm-1 col-xs-12" >
				...
				<div class="dataTables_filter searchFilterClass form-group">
						<div class="controls">
							<a href="<?php echo base_url();?>creditorbranches"><button class="btn btn-primary">Clear Search</button></a>
						</div>
				</div>
				</div>
				<div class="col-sm-6 col-xs-12" >
				<?php if(in_array('CreditorBranchAdd',$this->RolePermission)){?>
					<p align="right"><a href="<?php echo base_url();?>creditorbranches/addEdit" class="btn btn-primary icon-btn"><i class="fa fa-plus"></i>Add Branch</a></p>
				<?php }?>
