			...
			<div class="row">
				<div class="col-lg-6">
					<div class="page-header-left">
						<h3>GHD Declarations</h3>
					</div>
				</div>
				<div class="col-lg-6">
					<ol class="breadcrumb pull-right">
						<li class="breadcrumb-item"><a href="<?php echo base_url()?>ghddeclaration"><i data-feather="home"></i></a></li>
						<li class="breadcrumb-item active">GHD Declarations</li>
					</ol>
				</div>
			</div>
		</div>
    ...
    <div class="card">
    	<div class="page-title-border">
			...
			<?php if(in_array('GHDDeclarationAdd',$this->RolePermission)){?>
				<p><a href="<?php echo base_url();?>ghddeclaration/addEdit" class="btn btn-primary icon-btn pull-right"><i class="fa fa-plus"></i>Add Declaration</a></p>
			<?php }?>
		...
		<div class="container">
			<div class="row">
				...
				<div class="control-group clearFilter form-group" style="margin-left:5px;">
					<div class="controls">
						<a href="<?php echo base_url();?>ghddeclaration">
