		...
		<div class="card">
			<div class="card-body">
				<div class="btn-popup pull-right">
					<p><a href="<?php echo base_url();?>suminsured/addEdit" class="btn btn-primary icon-btn"><i class="fa fa-plus"></i>Add Sum Insured Type</a></p>
				...
				<div class="row">
				    <div class="col-sm-12 col-xs-12">
    					<div class="control-group clearFilter">
    						<div class="controls">
    							<a href="suminsured" tabindex="50"><button class="btn" style="margin:32px 10px 10px 10px;" tabindex="51">Clear Search</button></a>
    						</div>
    					</div>
    				</div>
				</div>
