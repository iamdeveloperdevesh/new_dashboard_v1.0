			...
			<div class="row">
				<div class="col-lg-6">
					<div class="page-header-left">
						<h3>Discrepancy Proposals</h3>
					</div>
				</div>
				<div class="col-lg-6">
					<ol class="breadcrumb pull-right">
						<li class="breadcrumb-item"><a href="<?php echo base_url()?>discrepancyproposals"><i data-feather="home"></i></a></li>
						<li class="breadcrumb-item active">Discrepancy Proposals</li>
					</ol>
				</div>
			</div>
		</div>
