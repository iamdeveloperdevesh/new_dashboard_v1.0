		...
		<div class="card">
			<div class="card-body">
				<div class="btn-popup pull-right">
					<p><a href="<?php echo base_url();?>policysubtype/addEdit" class="btn btn-primary icon-btn"><i class="fa fa-plus"></i>Add Policy Sub Type</a></p>
