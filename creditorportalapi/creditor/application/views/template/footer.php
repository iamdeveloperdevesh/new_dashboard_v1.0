            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 footer-copyright">
                        <p class="mb-0">© Copyright 2020. All right reserved by Aditya Birla.</p>
                    </div>
                    <div class="col-md-6">
                        <p class="pull-right mb-0">FynTune<i class="fa fa-heart"></i></p>
                    </div>
                </div>
            </div>
        </footer>
...
<!--Customizer admin-->
<!-- <script src="<?php echo base_url(); ?>assets/js/admin-customizer.js"></script> -->
