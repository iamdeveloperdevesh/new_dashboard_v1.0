...
function open_side_mob() {
    document.getElementById("mySidebar_mobile").style.width = "100%";
    document.getElementById("mySidebar_mobile").style.display = "block";
}

function close_side_mob() {
    document.getElementById("mySidebar_mobile").style.display = "none";
}

$(".menu-inner").addClass("menu-code");
$(".slimScrollDiv").addClass("menu-code");
