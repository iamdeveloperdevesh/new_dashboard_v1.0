...
$("#form_data").validate({
  ...
  messages: {
	...
	gym_name:"please enter specify gym name",
 ...
 submitHandler: function(form) {
		 ...
		 $.each($files, function (k, v) {
		  ...
		  form_data.append("gym_name",gym_name);
		  form_data.append("gym_address",gym_address);
