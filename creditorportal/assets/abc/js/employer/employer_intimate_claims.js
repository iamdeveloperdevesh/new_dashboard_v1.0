...
$("#intimate_claim").validate({
  ...
  messages: {
	...
	comment: "Please specify remark",
	date_admission: "Please specify admission date",
  ...
  submitHandler: function(form) {
  	var all_data = $("#intimate_claim").serialize() +'&data_override='+'NO';
  			$.ajax({
			type:'POST',
			url: '/employer_intimate_claims_add',
			data:all_data,
			success:function(result){
				...
				else if(data_response.success_new_claim)
				{
					...
					if(checkstr == true)
					{
						var all_data = $("#intimate_claim").serialize() +'&data_override='+'YES';
						$.ajax({
								type:'POST',
								url: 'employer_intimate_claims_add',
								data:all_data,
