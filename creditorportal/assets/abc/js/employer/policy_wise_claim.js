    ...
    $('#apply').on('click', function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                $.ajax({
                    url: "/employer/get_total_employee_policy_wise_enrollment_claims",
                    type: "POST",
                    async: false,
                    data: {from_date: from_date, to_date: to_date, type: type},
                    dataType: "json",
...
//                    data[0]['Total Employee'] = response.gmc
//                    data[1]['Total Employee'] = response.gtl
//                    data[2]['Total Employee'] = response.gpa
//		          show_chart(data);		
            }
        });
//             $.ajax({
...
//                dataType: "json",
//                success: function (response) {
////                 data[0]['Enrolled'] = response.gmc	
////                 data[1]['Enrolled'] = response.gtl	
////                 data[2]['Enrolled'] = response.gpa	
////		          show_chart(data);	
//            }
//            });
    });
