$(document).ready(function() {
    ...
    $("#emp_name").change(function() {
        var emp_id = $('#emp_name option:selected').val();
        get_policy(emp_id);
    });
    ...
    // 		 $.ajax({
    //                url: "/employer/get_family_memberrel_from_policy_no",
    //                type: "POST",
    //                data:
    //                    {policy_no:value,emp_id:emp_id}
    //                ,
    //                async: false,
    //                dataType: "json",
    //                success: function (response) {
    ...
    $('#patient_name').on('change', function() {
        $.ajax({
            url: "/employer/get_member_details",
            type: "POST",
            data: {
    ...
    $("body").on('click', ".bill_date", function() {
        ...
        if (bill_num)
        {
            ...
            $("#btn_add").click(function() {
                ...
                cols += '<td><input type="text" class="form-control claim_amount" name="claim_amount" value="" minlength="6" maxlength="6"/></td>';
...
//	}
        ...
        $.ajax({
            type: 'POST',
            url: "/employer_claims/save_hospitalizationdetails",
        ...
        /* $.post("/employer_claims/save_hospitalizationdetails", {
    ...
    $('#save').click(function() {
        ...
        var policy_numbers = $('#policy_no option:selected').val();
        ...
        $.ajax({
            type: 'POST',
            url: "/employer_claims/save_claims_bill",
            data: form_data,
            async: false,
            cache: false,
            dataType: 'json',
    ...
    $("#relationship_status").change(function() {
        ...
        $.ajax({
            url: "/employer/get_family_details_on_relationship",
            type: "POST",
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $.ajax({
                ...
                type: "POST",
                data:
                        {policy_no: $('#policy_no option:selected').val(), emp_id: emp_id}
                ,
                async: false,
                dataType: "json",
                success: function(response) {
