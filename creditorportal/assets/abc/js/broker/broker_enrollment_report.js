...
//                    $("#to_date").datepicker("option", "minDate", endDate);
    ...
    $('#export_excel').on('click', function() {
        if (employer_name == "") {
            ...
            window.location = '/broker/get_member_report_enrolled_from_policy_no?employer_name=' + $('#employer_name option:selected').val() + '&insurer_id=' + $('#insurer_id option:selected').val() + '&policy_no=' + $('#policy_no option:selected').val() + '&from_date=' + $("#from_date").val() + '&to_date=' + $("#to_date").val();
        }
