...
{
	var IdName  = certificate_no;
       
 $('button[id="'+IdName+'"]').html("Please wait...");
 $('button[id="'+IdName+'"]').attr("disabled", true);
 var  certificate_nos =  $('button[id="'+IdName+'"]').attr('data-id');
    $.post("/coi_download_abc",
     ...
     function (e) {
        ...
        var obj = JSON.parse(e);
          $('button[id="'+IdName+'"]').html('COI <i class="ti-file" style="font-weight: bold;"></i>');
        $('button[id="'+IdName+'"]').attr("disabled", false);
