...
*/
(function(M, I) {
    "object" === typeof module && module.exports ? (I["default"] = I, module.exports = M.document ? I(M) : I) : "function" === typeof define && define.amd ? define(function() {
        return I(M)
    }) : M.Highcharts = I(M)
    ...
    var I = function() {
        var a = "undefined" === typeof M ? window : M,
            ...
            u = c && 4 > parseInt(F.split("Firefox/")[1], 10);
    ...
    (function(a) {
        ...
        a.Fx.prototype = {
            dSetter: function() {
                var a = this.paths[0],
                    ...
                    x;
                if (1 === u) r = this.toD;
                else if (w === c.length && 1 > u)
                    for (; w--;) x = parseFloat(a[w]), r[w] = isNaN(x) ? c[w] : u * parseFloat(c[w] - x) + x;
                else r = c;
            ...
            update: function() {
                ...
                else a.attr ? a.element && a.attr(c, r, null, !0) : a.style[c] = r + this.unit;
                u && u.call(a, r, this)
            },
            run: function(h, c, r) {
                var u = this,
            ...
            step: function(h) {
                var c = +new Date,
                    ...
                    p = u.duration,
                    g = u.curAnim;
                w.attr && !w.element ? h = !1 : h || c >= p + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), r = g[this.prop] = !0, a.objectEach(g, function(a) {
                    !0 !== a && (r = !1)
                }), r && x && x.call(w), h = !1) : (this.pos = u.easing((c - this.startTime) / p), this.now = this.start + (this.end - this.start) * this.pos, this.update(), h = !0);
                return h
            },
            initPath: function(h, c, r) {
                ...
                function w(a, l) {
                    for (; a.length <
                        ...
                        v && (k = a.slice(a.length - n), [].splice.apply(a, [a.length, 0].concat(k)), f--)
                    }
                    a[0] = "M"
                }

                function x(a, f) {
                    for (var k = (b - a.length) / n; 0 < k && k--;) l = a.slice().splice(a.length / t - n, n * t), l[0] = f[b - n - k * n], m && (l[n - 6] = l[n - 2], l[n - 5] = l[n - 1]), [].splice.apply(a, [a.length / t, 0].concat(l)), v && k--
                }
                c = c || "";
                var p, g = h.startX,
                    d = h.endX,
                ...
                c.length && a.isNumber(p) && (b = r.length + p * t * n, H ? (w(c, r), x(r, c)) : (w(r, c), x(c, r)));
                return [c, r]
            },
            fillSetter: function() {
        ...
        a.attr = function(h, c, r) {
            var u;
            a.isString(c) ? a.defined(r) ? h.setAttribute(c, r) : h && h.getAttribute &&
                ((u = h.getAttribute(c)) || "class" !== c || (u = h.getAttribute(c + "Name"))) : a.defined(c) && a.isObject(c) && a.objectEach(c, function(a, c) {
                    h.setAttribute(c, a)
                });
            return u
        };
        ...
        a.formatSingle =
            function(h, c, r) {
                ...
                /f$/.test(h) ? (r = (r = h.match(u)) ? r[1] : -1, null !== c && (c = a.numberFormat(c, r, w.decimalPoint, -1 < h.indexOf(",") ? w.thousandsSep : ""))) : c = (r || a.time).dateFormat(h, c);
                return c
            };
        a.format = function(h, c, r) {
            for (var u = "{", w = !1, x, p, g, d, m = [], n; h;) {
                ...
                if (w) {
                    ...
                    d = p.length;
                    n = c;
                    for (g = 0; g < d; g++) n && (n = n[p[g]]);
                    x.length && (n = a.formatSingle(x.join(":"), n, r));
                    m.push(n)
                } else m.push(x);
                h = h.slice(u +
                    1);
        ...
        a.normalizeTickInterval = function(h, c, r, u, w) {
            ...
            r = a.pick(r, 1);
            x = h / r;
            c || (c = w ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10], !1 === u && (1 === r ? c = c.filter(function(a) {
                return 0 === a % 1
            }) : .1 >= r && (c = [1 / r])));
            for (u = 0; u < c.length && !(p = c[u], w && p * r >= h || !w && x <= (c[u] + (c[u + 1] || c[u])) / 2); u++);
            return p = a.correctFloat(p * r, -Math.round(Math.log(.001) / Math.LN10))
        };
        a.stableSort = function(a,
            c) {
            var h = a.length,
                u, w;
            for (w = 0; w < h; w++) a[w].safeI = w;
            a.sort(function(a, p) {
                u = c(a, p);
                return 0 === u ? a.safeI - p.safeI : u
            });
            for (w = 0; w < h; w++) delete a[w].safeI
        };
        ...
        a.numberFormat = function(h, c, r, u) {
            ...
            var w = a.defaultOptions.lang,
                ...
                p, g, d = h.toString().split("e"); - 1 === c ? c = Math.min(x, 20) : a.isNumber(c) ? c && d[1] && 0 > d[1] && (p = c + (+d[1]), 0 <= p ? (d[0] = (+d[0]).toExponential(p).split("e")[0], c = p) : (d[0] = d[0].split(".")[0] || 0, h = 20 > c ? (d[0] * Math.pow(10, d[1])).toFixed(c) : 0, d[1] = 0)) : c = 2;
            g = (Math.abs(d[1] ? d[0] : h) + Math.pow(10, -Math.max(c, x) - 1)).toFixed(c);
            x = String(a.pInt(g));
            p = 3 < x.length ? x.length % 3 : 0;
            r = a.pick(r, w.decimalPoint);
            u = a.pick(u, w.thousandsSep);
            h = (0 > h ? "-" : "") + (p ? x.substr(0, p) + u : "");
            h += x.substr(p).replace(/(\d{3})(?=\d)/g, "$1" + u);
            c && (h += r + g.slice(-c));
            d[1] && 0 !== +h && (h += "e" + d[1]);
            return h
        };
        ...
        a.getStyle = function(h, c, r) {
            if ("width" === c) return Math.max(0, Math.min(h.offsetWidth, h.scrollWidth, h.getBoundingClientRect && "none" === a.getStyle(h, "transform", !1) ? Math.floor(h.getBoundingClientRect().width) : Infinity) - a.getStyle(h, "padding-left") - a.getStyle(h, "padding-right"));
            ...
            if (h = G.getComputedStyle(h, void 0)) h = h.getPropertyValue(c), a.pick(r, "opacity" !== c) && (h = a.pInt(h));
            return h
        };
        ...
        a.addEvent = function(h, c, r, u) {
            var w,
                x = h.addEventListener || a.addEventListenerPolyfill;
            w = "function" === typeof h && h.prototype ? h.prototype.protoEvents = h.prototype.protoEvents || {} : h.hcEvents = h.hcEvents || {};
            a.Point && h instanceof a.Point && h.series && h.series.chart && (h.series.chart.runTrackerClick = !0);
            x && x.call(h, c, r, !1);
            w[c] || (w[c] = []);
            w[c].push(r);
            u && a.isNumber(u.order) && (r.order = u.order, w[c].sort(function(a, g) {
        ...
        a.removeEvent = function(h, c, r) {
            ...
            function w(g) {
                ...
                h.nodeName && (c ? (d = {}, d[c] = !0) : d = g, a.objectEach(d, function(a, b) {
                    if (g[b])
                        for (m = g[b].length; m--;) u(b, g[b][m])
                }))
            }
            var x, p;
            ["protoEvents", "hcEvents"].forEach(function(a) {
                var d = h[a];
                d && (c ? (x = d[c] || [], r ? (p = x.indexOf(r), -1 < p && (x.splice(p, 1), d[c] = x), u(c, r)) : (w(d), d[c] = [])) : (w(d), h[a] = {}))
            })
        };
        a.fireEvent = function(h, c, r, u) {
            var w, x, p, g, d;
            r = r || {};
            F.createEvent && (h.dispatchEvent || h.fireEvent) ? (w = F.createEvent("Events"), w.initEvent(c, !0, !0),
                a.extend(w, r), h.dispatchEvent ? h.dispatchEvent(w) : h.fireEvent(c, w)) : ["protoEvents", "hcEvents"].forEach(function(m) {
                if (h[m])
                    for (x = h[m][c] || [], p = x.length, r.target || a.extend(r, {
                            preventDefault: function() {
                                r.defaultPrevented = !0
                            },
                            target: h,
                            type: c
                        }), g = 0; g < p; g++)(d = x[g]) && !1 === d.call(h, r) && r.preventDefault()
            });
        ...
        a.animate = function(h, c, r) {
            ...
            r.easing =
                "function" === typeof r.easing ? r.easing : Math[r.easing] || Math.easeInOutSine;
            r.curAnim = a.merge(c);
            a.objectEach(c, function(d, g) {
                a.stop(h, g);
                p = new a.Fx(h, r, g);
                x = null;
                "d" === g ? (p.paths = p.initPath(h, h.d, c.d), p.toD = c.d, u = 0, x = 1) : h.attr ? u = h.attr(g) : (u = parseFloat(a.getStyle(h, g)) || 0, "opacity" !== g && (w = "px"));
                x || (x = d);
        ...
        a.seriesType = function(h, c, r, u, w) {
            var x = a.getOptions(),
                p = a.seriesTypes;
            x.plotOptions[h] = a.merge(x.plotOptions[c], r);
            p[h] = a.extendClass(p[c] ||
                function() {}, u);
            p[h].prototype.type = h;
            w && (p[h].prototype.pointClass = a.extendClass(a.Point, w));
            return p[h]
        };
        ...
        G.jQuery && (G.jQuery.fn.highcharts = function() {
            ...
            if (this[0]) return h[0] ? (new(a[a.isString(h[0]) ? h.shift() : "Chart"])(this[0], h[0], h[1]), this) : z[a.attr(this[0], "data-highcharts-chart")]
        })
    })(I);
    (function(a) {
        var z = a.isNumber,
        ...
        a.Color.prototype = {
            ...
            init: function(h) {
                ...
                else if (h && h.charAt && "#" === h.charAt() && (c = h.length, h = parseInt(h.substr(1), 16), 7 === c ? r = [(h & 16711680) >> 16, (h & 65280) >> 8, h & 255, 1] : 4 === c && (r = [(h & 3840) >> 4 | (h & 3840) >> 8, (h & 240) >> 4 | h & 240, (h & 15) << 4 | h & 15, 1])), !r)
                    for (u = this.parsers.length; u-- && !r;) w = this.parsers[u], (c = w.regex.exec(h)) && (r = w.parse(c));
                this.rgba = r || []
            },
            get: function(a) {
                var c = this.input,
                    h = this.rgba,
                    u;
                this.stops ? (u = F(c), u.stops = [].concat(u.stops), this.stops.forEach(function(c, h) {
                    u.stops[h] = [u.stops[h][0], c.get(a)]
                })) : u = h && z(h[0]) ? "rgb" === a || !a && 1 === h[3] ? "rgb(" + h[0] + "," + h[1] + "," + h[2] + ")" : "a" === a ? h[3] : "rgba(" + h.join(",") + ")" : c;
                return u
            },
            brighten: function(a) {
                var c, h = this.rgba;
                if (this.stops) this.stops.forEach(function(c) {
                    ...
                    for (c = 0; 3 > c; c++) h[c] += G(255 * a), 0 > h[c] && (h[c] = 0), 255 < h[c] && (h[c] = 255);
                return this
            },
    ...
    (function(a) {
        ...
        n(z.prototype, {
            ...
            init: function(e, q) {
                this.element = "span" ===
                    q ? x(q) : m.createElementNS(this.SVG_NS, q);
                this.renderer = e;
            ...
            complexColor: function(e, q, b) {
                var B = this.renderer,
                    l, d, n, g, J, m, E, v, P, c, t, K = [],
                    L;
                a.fireEvent(this.renderer, "complexColor", {
                    args: arguments
                }, function() {
                    e.radialGradient ? d = "radialGradient" :
                        e.linearGradient && (d = "linearGradient");
                    d && (n = e[d], J = B.gradients, E = e.stops, c = b.radialReference, f(n) && (e[d] = n = {
                        x1: n[0],
                        y1: n[1],
                        x2: n[2],
                        y2: n[3],
                        gradientUnits: "userSpaceOnUse"
                    }), "radialGradient" === d && c && !p(n.gradientUnits) && (g = n, n = k(n, B.getRadialAttr(c, g), {
                        gradientUnits: "userSpaceOnUse"
                    })), C(n, function(a, e) {
                        "id" !== e && K.push(e, a)
                    }), C(E, function(a) {
                        ...
                        0 ===
                            e[1].indexOf("rgba") ? (l = a.color(e[1]), v = l.get("rgb"), P = l.get("a")) : (v = e[1], P = 1);
            ...
            applyTextOutline: function(e) {
                var B = this.element,
                    q, f, k, l, d; - 1 !== e.indexOf("contrast") && (e = e.replace(/contrast/g, this.renderer.getContrast(B.style.fill)));
                e = e.split(" ");
                f = e[e.length - 1];
                if ((k = e[0]) && "none" !== k && a.svg) {
                    ...
                    k = k.replace(/(^[\d\.]+)(.*?)$/g, function(a, e, B) {
                        return 2 * e + B
                    });
                    for (d = e.length; d--;) q = e[d], "highcharts-text-outline" === q.getAttribute("class") && b(e, B.removeChild(q));
                    l = B.firstChild;
            ...
            attr: function(e, q, b, f) {
                var B, k = this.element,
                    l, d = this,
                    n, g, J = this.symbolCustomAttribs;
                "string" === typeof e && void 0 !== q && (B = e, e = {}, e[B] = q);
                "string" === typeof e ? d = (this[e + "Getter"] || this._defaultGetter).call(this, e, k) : (C(e, function(B, q) {
                    n = !1;
                    f || K(this, q);
                    this.symbolName && -1 !== a.inArray(q, J) && (l || (this.symbolAttr(e), l = !0), n = !0);
            ...
            updateShadows: function(a, e, q) {
                for (var B = this.shadows, b = B.length; b--;) q.call(B[b], "height" === a ? Math.max(e - (B[b].cutHeight || 0), 0) : "d" === a ? this.d : e, a, B[b])
            },
            addClass: function(a, e) {
                var B =
                    this.attr("class") || ""; - 1 === B.indexOf(a) && (e || (a = (B + (B ? " " : "") + a).replace("  ", " ")), this.attr("class", a));
                return this
            },
            hasClass: function(a) {
            ...
            symbolAttr: function(a) {
                var e = this;
                "x y r start end width height innerR anchorX anchorY".split(" ").forEach(function(B) {
                    e[B] = y(a[B], e[B])
                });
                e.attr({
            ...
            crisp: function(a, e) {
                ...
                p(a.strokeWidth) && (a.strokeWidth = e);
                return a
            },
            css: function(a) {
                var B = this.styles,
                ...
                d && (B && (a = n(B, q)), a && (null === a.width || "auto" === a.width ? delete this.textWidth : "text" === b.nodeName.toLowerCase() && a.width && (f = this.textWidth = e(a.width))), this.styles = a, f && !T && this.renderer.forExport && delete a.width, b.namespaceURI === this.SVG_NS ? (l = function(a, e) {
                    return "-" + e.toLowerCase()
                }, C(a, function(a, e) {
                    -1 === g.indexOf(e) && (k += e.replace(/([A-Z])/g, l) + ":" + a + ";")
                }), k && c(b, "style", k)) : w(b, a), this.added && ("text" === this.element.nodeName && this.renderer.buildText(this),
            ...
            strokeWidth: function() {
                ...
                var a = this.getStyle("stroke-width"),
                    q;
                a.indexOf("px") === a.length - 2 ? a = e(a) : (q = m.createElementNS(J, "rect"), c(q, {
                    width: a,
                    "stroke-width": 0
            ...
            updateTransform: function() {
                ...
                a = ["translate(" + a + "," + e + ")"];
                p(l) && a.push("matrix(" + l.join(",") + ")");
                f ? a.push("rotate(90) scale(-1,1)") : k && a.push("rotate(" + k + " " + y(this.rotationOriginX, d.getAttribute("x"), 0) + " " + y(this.rotationOriginY, d.getAttribute("y") ||
                    0) + ")");
                (p(q) || p(b)) && a.push("scale(" + y(q, 1) + " " + y(b, 1) + ")");
            ...
            align: function(a, e, q) {
                ...
                } else a = this.alignOptions, e = this.alignByTranslate, B = this.alignTo;
                q = y(q, f[B], f);
                B = a.align;
                f = a.verticalAlign;
                k =
                    (q.x || 0) + (a.x || 0);
                l = (q.y || 0) + (a.y || 0);
                "right" === B ? n = 1 : "center" === B && (n = 2);
                n && (k += (q.width - (a.width || 0)) / n);
            ...
            getBBox: function(a, e) {
                ...
                e = y(e, this.rotation);
                b = e * g;
                l = B.styledMode ? f && z.prototype.getStyle.call(f, "font-size") : k && k.fontSize;
                p(d) && (c = d.toString(), -1 === c.indexOf("\x3c") && (c = c.replace(/[0-9]/g, "0")), c += ["", e || 0, l, this.textWidth, k && k.textOverflow].join());
                c && !a && (q = m[c]);
                if (!q) {
                    if (v || B.forExport) {
                        try {
                            ...
                            }) && J("none"), q = f.getBBox ? n({}, f.getBBox()) : {
                                width: f.offsetWidth,
                    ...
                    B.isSVG && (a = q.width, B = q.height, v && (q.height = B = {
                        "11px,17": 14,
                        "13px,20": 16
                    } [k && k.fontSize + "," + Math.round(B)] || B), e && (q.width = Math.abs(B * Math.sin(b)) + Math.abs(a * Math.cos(b)), q.height = Math.abs(B * Math.cos(b)) + Math.abs(a * Math.sin(b))));
                    if (c && 0 < q.height) {
                        for (; 250 < E.length;) delete m[E.shift()];
                        m[c] || E.push(c);
                        m[c] = q
                    }
                }
            ...
            add: function(a) {
                ...
                B || (a ? a.element : e.box).appendChild(q);
            ...
            destroy: function() {
                ...
                a.safeRemoveChild(e);
                for (q.styledMode ||
                    a.destroyShadows(); f && f.div && 0 === f.div.childNodes.length;) e = f.parentGroup, a.safeRemoveChild(f.div), delete f.div, f = e;
            ...
            shadow: function(a, e, q) {
                ...
                if (!a) this.destroyShadows();
                    ...
                    d = y(a.width, 3);
                    n = (a.opacity || .15) / d;
                    g = this.parentInverted ? "(-1,-1)" : "(" + y(a.offsetX, 1) + ", " + y(a.offsetY, 1) + ")";
                    for (f = 1; f <= d; f++) B = k.cloneNode(0), l = 2 * d + 1 - 2 * f, c(B, {
                        ...
                        fill: "none"
                    }), B.setAttribute("class", (B.getAttribute("class") || "") + " highcharts-shadow"), q && (c(B, "height", Math.max(c(B, "height") - l, 0)), B.cutHeight = l), e ? e.element.appendChild(B) : k.parentNode && k.parentNode.insertBefore(B, k), b.push(B);
                    this.shadows = b
                }
                return this
            },
            ...
            titleSetter: function(a) {
                ...
                e.appendChild(m.createTextNode(String(y(a), "").replace(/<[^>]*>/g, "").replace(/&lt;/g, "\x3c").replace(/&gt;/g, "\x3e")))
            },
            ...
            zIndexSetter: function(a, q) {
                ...
                l = this.added;
                var g;
                p(a) ? (d.setAttribute("data-z-index", a), a = +a, this[q] === a && (l = !1)) : p(this[q]) && d.removeAttribute("data-z-index");
                this[q] = a;
                if (l) {
                    (a = this.zIndex) && f && (f.handleZ = !0);
                    q = k.childNodes;
                    for (g = q.length - 1; 0 <= g && !B; g--)
                        if (f = q[g], l = f.getAttribute("data-z-index"), n = !p(l), f !== d)
                            if (0 > a && n &&
                                !b && !g) k.insertBefore(d, q[g]), B = !0;
                            else if (e(l) <= a || n && (!p(a) || 0 <= a)) k.insertBefore(d, q[g + 1] || null), B = !0;
        ...
        z.prototype["stroke-widthSetter"] = z.prototype.strokeSetter = function(a, e, q) {
            this[e] = a;
            this.stroke && this["stroke-width"] ? (z.prototype.fillSetter.call(this, this.stroke, "stroke", q), q.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0) : "stroke-width" === e && 0 === a && this.hasStroke && (q.removeAttribute("stroke"), this.hasStroke = !1)
        };
        ...
        n(F.prototype, {
            ...
            init: function(a, e, q, b,
                ...
                this.boxWrapper = d;
                this.alignedObjects = [];
                this.url = (v || A) && m.getElementsByTagName("base").length ? R.location.href.split("#")[0].replace(/<[^>]*>/g, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
                this.createElement("desc").add().element.appendChild(m.createTextNode("Created with Highcharts 7.0.2"));
                ...
                this.setSize(e, q, !1);
                var n;
                v && a.getBoundingClientRect && (e = function() {
                    w(a, {
                        left: 0,
                        top: 0
                    });
            ...
            truncate: function(a, e, q, b, f, k, l) {
                var d = this,
                    n = a.rotation,
                    g, B = b ? 1 : 0,
                    J = (q || b).length,
                    ...
                    v = function(k, n) {
                        ...
                        if (void 0 === c[n])
                            ...
                            } catch (Z) {} else d.getSpanWidth && (p(l(q || b, k)), c[n] = f + d.getSpanWidth(a, e));
                        return c[n]
                    },
                    t, C;
                a.rotation = 0;
                t = v(e.textContent.length);
                if (C = f + t > k) {
                    for (; B <= J;) E = Math.ceil((B + J) / 2), b && (g = l(b, E)), t = v(E, g && g.length - 1), B === J ? B = J + 1 : t > k ? J = E - 1 : B = E;
            ...
            buildText: function(a) {
                var q = a.element,
                    ...
                    N = function(a) {
                        var k;
                        b.styledMode || (k = /(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize :
                            L || b.style.fontSize || 12);
                        return p ? e(p) : b.fontMetrics(k, a.getAttribute("style") ? a : q).h
                    },
                    D = function(a, e) {
                        ...
                        l.forEach(function(e) {
                            if ("" !== e || 1 === l.length) {
                                var p = {},
                                    ...
                                    C, y;
                                (C = x(e, "class")) && c(v, "class", C);
                                if (C = x(e, "style")) C = C.replace(/(;| |^)color([ :])/, "$1fill$2"), c(v, "style", C);
                                (y = x(e, "href")) && !f && (c(v, "onclick", 'location.href\x3d"' + y + '"'), c(v, "class", "highcharts-anchor"), b.styledMode || w(v, {
                                    cursor: "pointer"
                                }));
                                e = D(e.replace(/<[a-zA-Z\/](.|\n)*?>/g,
                                    "") || " ");
                                if (" " !== e) {
                                    v.appendChild(m.createTextNode(e));
                                    d ? p.dx = 0 : k && null !== g && (p.x = g);
                                    c(v, p);
                                    q.appendChild(v);
                                    !d && h && (!T && f && w(v, {
                                        display: "block"
                                    ...
                                    if (E) {
                                        var A = e.replace(/([^\^])-/g, "$1- ").split(" "),
                                            p = !K && (1 < l.length || k || 1 < A.length);
                                        y = 0;
                                        var H = N(v);
                                        if (t) n = b.truncate(a, v, e, void 0, 0, Math.max(0, E - parseInt(L || 12, 10)), function(a, e) {
                                            return a.substring(0, e) + "\u2026"
                                        });
                                        else if (p)
                                            for (; A.length;) A.length && !K && 0 < y && (v = m.createElementNS(J, "tspan"), c(v, {
                                                dy: H,
                                                x: g
                                            }), C && c(v, "style", C), v.appendChild(m.createTextNode(A.join(" ").replace(/- /g,
                                                "-"))), q.appendChild(v)), b.truncate(a, v, null, A, 0 === y ? B : 0, E, function(a, e) {
            ...
            button: function(a, e, q, b, f, l, d, g, J) {
                var B = this.label(a,
                        e, q, J, null, null, null, null, "button"),
                    E = 0,
                    v = this.styledMode;
                B.attr(k({
                    padding: 8,
                ...
                B.setState = function(a) {
                    ...
                    v || B.attr([f, l, d, g][a || 0]).css([m, p, c, C][a || 0])
                };
                v || B.attr(f).css(n({
                    cursor: "default"
                }, m));
            ...
            crispLine: function(a, e) {
                ...
                a[2] ===
                    a[5] && (a[2] = a[5] = Math.round(a[2]) + e % 2 / 2);
                return a
            },
            path: function(a) {
            ...
            rect: function(a, e, q, b, k, f) {
                ...
                this.styledMode || (void 0 !== f && (a.strokeWidth = f, a = l.crisp(a)), a.fill = "none");
                k && (a.r = k);
            ...
            image: function(a, e, q, b, k, f) {
                ...
                f ? (g(d.element, "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw\x3d\x3d"),
                    l = new R.Image, G(l, "load", J), l.src = a, l.complete && J({})) : g(d.element, a);
                return d
            },
            symbol: function(a, e, q, b, k, f) {
                var l = this,
                    ...
                    B, t;
                v ? (d = this.path(c), l.styledMode || d.attr("fill", "none"), n(d, {
                    symbolName: E,
                    x: e,
                    y: q,
                    width: b,
                    height: k
                }), f && n(d, f)) : J && (B = a.match(g)[1], d = this.image(B), d.imgwidth = y(N[B] && N[B].width, f && f.width), d.imgheight = y(N[B] && N[B].height, f &&
                    f.height), t = function() {
                    d.attr({
                        width: d.width,
                        height: d.height
                    ...
                    d[a + "Setter"] = function(a, e) {
                        ...
                        this[e] = a;
                        p(b) && (this.element && this.element.setAttribute(e, b), this.alignByTranslate || (q[k] = ((this[e] || 0) - b) / 2, this.attr(q)))
                    }
                }), p(e) && d.attr({
                    x: e,
                    y: q
                }), d.isImg = !0, p(d.imgwidth) && p(d.imgheight) ? t() : (d.attr({
                    width: 0,
                    height: 0
                }), x("img", {
                    onload: function() {
            ...
            symbols: {
                ...
                arc: function(a, e, q, b, k) {
                    var f = k.start,
                        l = k.r || q,
                        d = k.r || b || q,
                        n = k.end - .001;
                    q = k.innerR;
                    b = y(k.open, .001 > Math.abs(k.end - k.start - 2 * Math.PI));
                    var g = Math.cos(f),
                        J = Math.sin(f),
                        E = Math.cos(n),
                        n = Math.sin(n);
                    k = .001 > k.end - f - Math.PI ? 0 : 1;
                    l = ["M", a + l * g, e + d * J, "A", l, d, 0, k, 1, a + l * E, e + d * n];
                    p(q) && l.push(b ? "M" : "L", a + q * E, e + q * n, "A", q, q, 0, k, 0,
                        a + q * g, e + q * J);
                    l.push(b ? "" : "Z");
                    return l
                },
                callout: function(a, e, q, b, k) {
                    ...
                    k = k && k.anchorY;
                    var n;
                    n = ["M", a + f, e, "L", a + q - f, e, "C", a + q, e, a + q, e, a + q, e + f, "L", a + q, e + b - f, "C", a + q, e + b, a + q, e + b, a + q - f, e + b, "L", a + f, e + b, "C", a, e + b, a, e + b, a, e + b - f, "L", a, e + f, "C", a, e, a, e, a + f, e];
                    d && d > q ? k > e + l && k < e + b - l ? n.splice(13, 3, "L", a + q, k - 6, a + q + 6, k, a + q, k + 6, a + q, e + b - f) : n.splice(13, 3, "L", a + q, b / 2, d, k, a + q, b / 2, a + q, e + b - f) : d && 0 > d ? k > e + l && k < e + b - l ? n.splice(33, 3, "L", a, k + 6, a - 6, k, a, k - 6, a, e + f) : n.splice(33, 3,
                        "L", a, b / 2, d, k, a, b / 2, a, e + f) : k && k > b && d > a + l && d < a + q - l ? n.splice(23, 3, "L", d + 6, e + b, d, e + b + 6, d - 6, e + b, a + f, e + b) : k && 0 > k && d > a + l && d < a + q - l && n.splice(3, 3, "L", d - 6, e, d, e - 6, d + 6, e, q - f, e);
                    return n
                }
            },
            clipRect: function(e, q, b, k) {
                var f = a.uniqueKey(),
                    d = this.createElement("clipPath").attr({
                        id: f
                    }).add(this.defs);
                e = this.rect(e, q, b, k, 0).add(d);
                e.id = f;
                e.clipPath = d;
                e.count = 0;
                return e
            ...
            text: function(a, e, q, b) {
                ...
                b || (a.xSetter = function(a, e, q) {
                    var b = q.getElementsByTagName("tspan"),
                        k, f = q.getAttribute(e),
                        d;
                    for (d = 0; d < b.length; d++) k = b[d], k.getAttribute(e) === f && k.setAttribute(e, a);
                    q.setAttribute(e, a)
                });
                return a
            },
            fontMetrics: function(a, q) {
                a = !this.styledMode && /px/.test(a) || !R.getComputedStyle ? a || q && q.style && q.style.fontSize || this.style && this.style.fontSize : q && z.prototype.getStyle.call(q, "font-size");
                a = /px/.test(a) ? e(a) : 12;
            ...
            label: function(e, b, f, d, l, g, J, E, v) {
                var m = this,
                    c = m.styledMode,
                    t = m.g("button" !== v && "label"),
                    C = t.text = m.text("", 0, 0, J).attr({
                        zIndex: 1
                    }),
                    K, L, B = 0,
                    y = 3,
                ...
                U = function() {
                    var a = C.element.style,
                        e = {};
                    L = (void 0 === H || void 0 === h || T) && p(C.textStr) &&
                        C.getBBox();
                    t.width = (H || L.width || 0) + 2 * y + A;
                    t.height = (h || L.height || 0) + 2 * y;
                    u = y + Math.min(m.fontMetrics(a && a.fontSize, C).b, L ? L.height : Infinity);
                    w && (K || (t.box = K = m.symbols[d] || R ? m.symbol(d) : m.rect(), K.addClass(("button" === v ? "" : "highcharts-label-box") + (v ? " highcharts-" + v + "-box" : "")), K.add(t), a = P(), e.x = a, e.y = (E ? -u : 0) + a), e.width = Math.round(t.width), e.height = Math.round(t.height), K.attr(n(e, x)), x = {})
                };
                O = function() {
                    var a = A + y,
                        e;
                    e = E ? 0 : u;
                    p(H) && L && ("center" === T || "right" === T) && (a += {
                        center: .5,
                        right: 1
                    } [T] * (H - L.width));
                    if (a !== C.x || e !== C.y) C.attr("x", a), C.hasBoxWidthChanged && (L = C.getBBox(!0), U()), void 0 !== e && C.attr("y", e);
                    C.x = a;
                    C.y = e
                };
                S = function(a, e) {
                ...
                c ? t.rSetter = function(a, e) {
                    ...
                    "r" !== e && ("fill" === e && a && (w = !0), t[e] = a);
                    S(e, a)
                };
                t.anchorXSetter = function(a, e) {
                    l = t.anchorX = a;
                    S(e, Math.round(a) - P() - N)
                };
                ...
                t.xSetter = function(a) {
                    t.x =
                        a;
                    B && (a -= B * ((H || L.width) + 2 * y), t["forceAnimate:x"] = !0);
                    N = Math.round(a);
                    t.attr("translateX", N)
                };
        ...
        c(g.prototype, {
            htmlCss: function(a) {
                var b = "SPAN" === this.element.tagName && a && "width" in a,
                    ...
                    f;
                b && (delete a.width, this.textWidth = d, f = !0);
                a &&
                    "ellipsis" === a.textOverflow && (a.whiteSpace = "nowrap", a.overflow = "hidden");
                ...
                if (this.added) {
                    ...
                    if ("SPAN" === b.tagName) {
                        var A = this.rotation,
                            ...
                            y;
                        (y = E !== this.oldTextWidth) && !(y = E > this.oldTextWidth) && ((y = this.textPxLength) || (G(b, {
                            width: "",
                            whiteSpace: k || "nowrap"
                        }), y = b.offsetWidth), y = y > E);
                        y &&
                            (/[ \-]/.test(b.textContent || b.innerText) || "ellipsis" === b.style.textOverflow) ? (G(b, {
                                width: E + "px",
                                display: "block",
                                whiteSpace: k || "normal"
                            }), this.oldTextWidth = E, this.hasBoxWidthChanged = !0) : this.hasBoxWidthChanged = !1;
                        C !== this.cTT && (k = a.fontMetrics(b.style.fontSize, b).b, !h(A) || A === (this.oldRotation || 0) && m === this.oldAlign || this.setSpanRotation(A, c, k), this.getSpanCorrection(!h(A) && this.textPxLength || b.offsetWidth, k, c, A, m));
                        G(b, {
            ...
            setSpanRotation: function(a, b, d) {
                ...
                f[l] = f.transform = "rotate(" + a + "deg)";
                f[l + (r ? "Origin" : "-origin")] = f.transformOrigin = 100 * b + "% " + d + "px";
                G(this.element, f)
            },
                    ...
                    p = function(a, b) {
                        ["opacity", "visibility"].forEach(function(k) {
                            a[k + "Setter"] = function(a, e, q) {
                                g.prototype[k + "Setter"].call(this, a, e, q);
                                b[e] = a
                            }
                        });
                        a.addedSetters = !0
                        ...
                        if (b = a.div, !b) {
                            ...
                            d.reverse().forEach(function(a) {
                                function e(e, q) {
                                    a[q] = e;
                                    "translateX" ===
                                    q ? l.left = e + "px" : l.top = e + "px";
                                    a.doTransform = !0
                                }
                                var l, g = z(a.element, "class");
                                g && (g = {
                                    className: g
                                });
        ...
        a.Time.prototype = {
            ...
            update: function(a) {
                ...
                (this.variableTimezone = !(c && !a.getTimezoneOffset && !a.timezone)) || this.timezoneOffset ? (this.get = function(a, g) {
                    ...
                    else m = x.getTimezoneOffset(g), m = g.getTime() - m, g.setTime(m), g["setUTC" + a](d), a = x.getTimezoneOffset(g), m = g.getTime() + a, g.setTime(m)
            ...
            makeTime: function(c, r, x, p, g, d) {
                var m, n, b;
                this.useUTC ? (m = this.Date.UTC.apply(0, arguments), n = this.getTimezoneOffset(m), m += n, b = this.getTimezoneOffset(m), n !== b ? m += b - n : n - 36E5 !== this.getTimezoneOffset(m - 36E5) || a.isSafari || (m -= 36E5)) : m = (new this.Date(c, r, h(x, 1), h(p, 0), h(g, 0), h(d, 0))).getTime();
                return m
            },
            ...
            getTimeTicks: function(a, r, x, p) {
                ...
                if (z(r)) {
                    ...
                    l >= c.minute &&
                        g.set("Minutes", m, l >= c.hour ? 0 : f * Math.floor(g.get("Minutes", m) / f));
                    ...
                    l === c.week && (b = g.get("Day", m), g.set("Date", m, g.get("Date", m) - b + p + (b < p ? -7 : 0)));
                    b = g.get("FullYear", m);
                    p = g.get("Month", m);
                    var t = g.get("Date", m),
                        H = g.get("Hours",
                            m);
                    r = m.getTime();
                    g.variableTimezone && (v = x - r > 4 * c.month || g.getTimezoneOffset(r) !== g.getTimezoneOffset(x));
                    r = m.getTime();
                    for (m = 1; r < x;) d.push(r), r = l === c.year ? g.makeTime(b + m * f, 0) : l === c.month ? g.makeTime(b, p + m * f) : !v || l !== c.day && l !== c.week ? v && l === c.hour && 1 < f ? g.makeTime(b, p, t, H + m * f) : r + l * f : g.makeTime(b, p, t + m * f * (l === c.day ? 1 : 7)), m++;
                    d.push(r);
    ...
    (function(a) {
        ...
        a.setOptions = function(z) {
            a.defaultOptions = F(!0, a.defaultOptions, z);
        ...
        a.Tick.prototype = {
            addLabel: function() {
                var c = this,
                    ...
                    f = f.info,
                    D, A, k, E;
                p.isDatetimeAxis && f && (A = d.time.resolveDTLFormat(g.dateTimeLabelFormats[!g.grid && f.higherRanks[b] || f.unitName]), D = A.main);
                c.isFirst = v;
                c.isLast = t;
                c.formatCtx = {
                    axis: p,
                    ...
                    tickPositionInfo: f,
                    value: p.isLog ? z(p.lin2log(m)) : m,
                    pos: b
                };
                g = p.labelFormatter.call(c.formatCtx, this.formatCtx);
                if (E = A && A.list) c.shortenLabel = function() {
                    for (k = 0; k < E.length; k++)
                        if (h.attr({
                                text: p.labelFormatter.call(a.extend(c.formatCtx, {
                                    dateTimeLabelFormat: E[k]
                                }))
                            }), h.getBBox().width < p.getSlotWidth(c) - 2 * u(l.padding, 5)) return;
                    h.attr({
                        text: ""
                    })
                };
                if (F(h)) h && h.textStr !== g && (!h.textWidth || l.style && l.style.width || h.styles.width || h.css({
                    width: null
                }), h.attr({
                    text: g
                }));
            ...
            handleOverflow: function(a) {
                var c = this.axis,
                    ...
                    A = 1,
                    k, E = {};
                if (f || "justify" !== u(g.overflow, "justify")) 0 > f && d - v * t < b ? k = Math.round(d / Math.cos(f * w) - b) : 0 < f && d + v * t > n && (k = Math.round((m - d) / Math.cos(f * w)));
                else if (m = d + (1 - v) * t, d - v * t < b ? D = a.x + D * (1 - v) - b : m > n && (D = n - a.x + D * v, A = -1), D = Math.min(h, D), D < h && "center" === c.labelAlign && (a.x += A * (h - D - v * (h - Math.min(t, D)))), t > D || c.autoRotation && (l.styles || {}).width) k = D;
                k && (this.shortenLabel ? this.shortenLabel() : (E.width = Math.floor(k), (g.style || {}).textOverflow || (E.textOverflow = "ellipsis"), l.css(E)))
            },
            getPosition: function(c,
                ...
                c = {
                    x: c ? a.correctFloat(m.translate(p + g, null, null, d) + m.transB) : m.left + m.offset + (m.opposite ? (d && n.oldChartWidth || n.chartWidth) - m.right - m.left : 0),
                    y: c ? b - m.bottom + m.offset - (m.opposite ? m.height : 0) : a.correctFloat(b - m.translate(p + g, null, null, d) - m.transB)
                };
            ...
            getLabelPosition: function(a, c, g, d, m, n, b, l) {
                var f = this.axis,
                    v = f.transA,
                    t = f.reversed,
                    p = f.staggerLines,
                    ...
                    A = m.y,
                    k = d || f.reserveSpaceDefault ?
                    0 : -f.labelOffset * ("center" === f.labelAlign ? .5 : 1),
                    E = {};
                F(A) || (A = 0 === f.side ? g.rotation ? -8 : -g.getBBox().height : 2 === f.side ? D.y + 8 : Math.cos(g.rotation * w) * (D.y - g.getBBox(!1, 0).height / 2));
                a = a + m.x + k + D.x - (n && d ? n * v * (t ? -1 : 1) : 0);
                c = c + A - (n && !d ? n * v * (t ? 1 : -1) : 0);
                p && (g = b / (l || 1) % p, f.opposite && (g = p - g - 1), c += f.labelOffset / p * g);
                E.x = a;
                E.y = Math.round(c);
            ...
            getMarkPath: function(a, c, g, d, m, n) {
            ...
            renderGridLine: function(a,
                ...
                var d = this.axis,
                    ...
                    A = m[p + "LineColor"],
                    m = m[p + "LineDashStyle"];
                n || (d.chart.styledMode || (b.stroke = A, b["stroke-width"] = h, m && (b.dashstyle = m)), f || (b.zIndex = 1), a && (c = 0), this.gridLine = n = t.path().attr(b).addClass("highcharts-" + (f ? f + "-" : "") + "grid-line").add(d.gridGroup));
                if (n && (g = d.getPlotLinePath(l + v, n.strokeWidth() * g, a, "pass"))) n[a || this.isNew ? "attr" :
                    "animate"]({
                    d: g,
                    opacity: c
                })
            ...
            renderMark: function(a, c, g) {
                ...
                var h = u(m[l + "Width"], !b && d.isXAxis ? 1 : 0),
                    m = m[l + "Color"];
                f && (d.opposite && (f[0] = -f[0]), t && (this.mark = v = n.path().addClass("highcharts-" + (b ? b + "-" : "") + "tick").add(d.axisGroup), d.chart.styledMode || v.attr({
                    stroke: m,
                    "stroke-width": h
                })), v[t ? "attr" : "animate"]({
                    d: this.getMarkPath(p, a, f[0], v.strokeWidth() * g, d.horiz, n),
                    opacity: c
                }))
            },
            ...
            render: function(c, p, g) {
                ...
                g = u(g, 1);
                this.isActive = !0;
                this.renderGridLine(p, g, d);
                this.renderMark(n, g, d);
                this.renderLabel(n, p, g, c);
                this.isNew = !1;
    ...
    var X = function(a) {
        ...
        a.extend(y.prototype, {
            ...
            init: function(a, q) {
                ...
                b.len = 0;
                b.minRange =
                    b.userMinRange = f.minRange || f.maxZoom;
                b.range = f.range;
                b.offset = f.offset || 0;
                b.stacks = {};
                b.oldStacks = {};
                ...
                b.max = null;
                b.min = null;
                b.crosshair = D(f.crosshair, k(a.options.tooltip.crosshairs)[e ? 0 : 1], !1);
                q = b.options.events; - 1 === a.axes.indexOf(b) && (e ? a.axes.splice(a.xAxis.length, 0, b) : a.axes.push(b), a[b.coll].push(b));
                b.series = b.series || [];
            ...
            setOptions: function(a) {
                this.options = v(this.defaultOptions, "yAxis" === this.coll && this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], v(u[this.coll], a));
            ...
            defaultLabelFormatter: function() {
                var e = this.axis,
                    ...
                    1E3,
                    g = l && l.length,
                    n, c = e.options.labels.format,
                    e = e.isLog ? Math.abs(q) : e.tickInterval;
                if (c) n = m(c, this, b);
                else if (k) n = q;
                else if (f) n = b.dateFormat(f, q);
                else if (g && 1E3 <= e)
                    for (; g-- && void 0 === n;) b = Math.pow(d, g + 1), e >= b && 0 === 10 * q % b && null !== l[g] && 0 !== q && (n = a.numberFormat(q / b, -1) + l[g]);
                ...
                d(this, "getSeriesExtremes", null, function() {
                    ...
                    a.series.forEach(function(e) {
                        if (e.visible || !q.options.chart.ignoreHiddenSeries) {
                            ...
                            if (a.isXAxis) b = e.xData, b.length && (e = h(b), k = G(b), l(e) || e instanceof Date || (b = b.filter(l), e = h(b), k = G(b)), b.length && (a.dataMin = Math.min(D(a.dataMin, b[0], e), e), a.dataMax = Math.max(D(a.dataMax, b[0], k), k)));
                            else if (e.getExtremes(), k = e.dataMax, e = e.dataMin, w(e) && w(k) &&
            ...
            translate: function(a, q, b, k, f, d) {
                var e = this.linkedParent || this,
                    g = 1,
                    n = 0,
                    c = k ? e.oldTransA : e.transA;
                k = k ? e.oldMin : e.min;
                var t = e.minPixelPadding;
                f = (e.isOrdinal || e.isBroken || e.isLog && f) && e.lin2val;
                c || (c = e.transA);
                b && (g *= -1, n = e.len);
                e.reversed && (g *= -1, n -= g * (e.sector || e.len));
                q ? (a = (a * g + n - t) / c + k, f && (a = e.lin2val(a))) :
                    (f && (a = e.val2lin(a)), a = l(k) ? g * (a - k) * c + n + g * t + (l(d) ? c * d : 0) : void 0);
                return a
            },
            ...
            getPlotLinePath: function(a, q, b, k, f) {
                var e = this,
                    g = e.chart,
                    n = e.left,
                    c = e.top,
                    t, m, v, E, C = b && g.oldChartHeight || g.chartHeight,
                    p = b && g.oldChartWidth || g.chartWidth,
                    h, L = e.transB,
                    y, A = function(a, e, q) {
                        if ("pass" !== k && a < e || a > q) k ? a = Math.min(Math.max(e, a), q) : h = !0;
                        return a
                    };
                y = {
                    value: a,
                ...
                d(this, "getPlotLinePath", y, function(d) {
                    f = D(f, e.translate(a, null, null, b));
                    f = Math.min(Math.max(-1E5, f), 1E5);
                    t = v = Math.round(f + L);
                    m = E = Math.round(C - f - L);
                    l(f) ? e.horiz ? (m = c, E = C - e.bottom, t = v = A(t, n, n + e.width)) : (t = n, v = p - e.right, m = E = A(m, c, c + e.height)) : (h = !0, k = !1);
                    d.path = h && !k ? null : g.renderer.crispLine(["M", t, m, "L", v, E], q || 1)
                });
                return y.path
            },
            getLinearTickPositions: function(a, q, b) {
                var e, k = r(Math.floor(q / a) * a);
                b = r(Math.ceil(b / a) * a);
                var f = [],
                    d;
                r(k + a) === k &&
            ...
            getMinorTickPositions: function() {
                var a = this,
                    ...
                    g = d - l;
                if (g && g / k < a.len / 3)
                    if (a.isLog) this.paddedTicks.forEach(function(e, q, b) {
                        q && f.push.apply(f, a.getLogTickPositions(k,
                            b[q - 1], b[q], !0))
                    });
                    else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval()) f = f.concat(a.getTimeTicks(a.normalizeTimeTickInterval(k), l, d, q.startOfWeek));
                else
                    for (q = l + (b[0] - l) % k; q <= d && q !== f[0]; q += k) f.push(q);
            ...
            adjustForMinRange: function() {
                ...
                this.isXAxis && void 0 === this.minRange && !this.isLog && (w(a.min) || w(a.max) ? this.minRange = null : (this.series.forEach(function(a) {
                    n = a.xData;
                    for (l = c = a.xIncrement ? 1 : n.length -
                        1; 0 < l; l--)
                        if (g = n[l] - n[l - 1], void 0 === d || g < d) d = g
                }), this.minRange = Math.min(5 * d, this.dataMax - this.dataMin)));
                b - q < this.minRange && (k = this.dataMax - this.dataMin >= this.minRange, t = this.minRange, f = (t - b + q) / 2, f = [q - f, D(a.min, q - f)], k && (f[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin), q = G(f), b = [q + t, D(a.max, q + t)], k && (b[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax), b = h(b), b - q < t && (f[0] = b - t, f[1] = D(a.min, b - t), q = G(f)));
                this.min = q;
                this.max = b
            },
            getClosest: function() {
                ...
                this.categories ? a = 1 : this.series.forEach(function(e) {
                    ...
                    !e.noSharedTooltip && w(q) && b && (a = w(a) ? Math.min(a, q) : q)
                });
                return a
            },
            nameToX: function(a) {
                ...
                w(k) || (k = !1 === this.options.uniqueNames ? a.series.autoIncrement() : e ? f.indexOf(a.name) : D(f.keys[a.name], -1)); - 1 === k ? e || (d = f.length) : d = k;
            ...
            updateNames: function() {
                ...
                0 < b.length && (Object.keys(b.keys).forEach(function(a) {
                    ...
                    e.data.forEach(function(b, q) {
                        var f;
                        b && b.options && void 0 !== b.name && (f = a.nameToX(b), void 0 !== f && f !== b.x && (b.x = f, e.xData[q] = f))
                    })
                }))
            },
            setAxisTranslation: function(a) {
                var e = this,
                    ...
                    m = e.transA,
                    v = e.isXAxis;
                if (v || t || k) l = e.getClosest(), c ? (g = c.minPointOffset, n = c.pointRangePadding) : e.series.forEach(function(a) {
                    var b = t ? 1 : v ? D(a.options.pointRange, l, 0) : e.axisPointRange || 0;
                    a = a.options.pointPlacement;
                    k = Math.max(k, b);
                    e.single || (g = Math.max(g, v && f(a) ? 0 : b / 2), n = Math.max(n, v && "on" === a ? 0 : b))
                }), c = e.ordinalSlope && l ? e.ordinalSlope / l : 1, e.minPointOffset = g *= c, e.pointRangePadding = n *= c, e.pointRange = Math.min(k, b), v && (e.closestPointRange = l);
                a && (e.oldTransA = m);
                e.translationSlope = e.transA =
                    m = e.staticScale || e.len / (b + n || 1);
                e.transB = e.horiz ? e.left : e.bottom;
                e.minPixelPadding = m * g;
            ...
            setTickInterval: function(e) {
                var b = this,
                    ...
                    x = b.softThreshold,
                    u, z, G;
                c || A || v || this.getTickAmount();
                z = D(b.userMin, k.min);
                G = D(b.userMax, k.max);
                v ? (b.linkedParent = f[b.coll][k.linkedTo], p = b.linkedParent.getExtremes(), b.min = D(p.min, p.dataMin), b.max = D(p.max, p.dataMax), k.type !== b.linkedParent.options.type && a.error(11, 1, f)) : (!x && w(H) && (b.dataMin >= H ? (p = H, C = 0) : b.dataMax <= H && (u = H, E = 0)), b.min = D(z, p, b.dataMin), b.max = D(G, u, b.dataMax));
                g && (b.positiveValuesOnly && !e && 0 >= Math.min(b.min, D(b.dataMin, b.min)) && a.error(10, 1, f), b.min = r(b.log2lin(b.min), 15), b.max = r(b.log2lin(b.max), 15));
                b.range && w(b.max) && (b.userMin = b.min = z = Math.max(b.dataMin, b.minFromRange()),
                    b.userMax = G = b.max, b.range = null);
                d(b, "foundExtremes");
                b.beforePadding && b.beforePadding();
                b.adjustForMinRange();
                !(A || b.axisPointRange || b.usePercentage || v) && w(b.min) && w(b.max) && (f = b.max - b.min) && (!w(z) && C && (b.min -= f * C), !w(G) && E && (b.max += f * E));
                ...
                l(k.ceiling) && (b.max = Math.max(Math.min(b.max, k.ceiling), D(b.userMax,
                    -Number.MAX_VALUE)));
                x && w(b.dataMin) && (H = H || 0, !w(z) && b.min < H && b.dataMin >= H ? b.min = H : !w(G) && b.max > H && b.dataMax <= H && (b.max = H));
                b.tickInterval = b.min === b.max || void 0 === b.min || void 0 === b.max ? 1 : v && !h && y === b.linkedParent.options.tickPixelInterval ? h = b.linkedParent.tickInterval : D(h, this.tickAmount ? (b.max - b.min) / Math.max(this.tickAmount - 1, 1) : void 0, A ? 1 : (b.max - b.min) * y / Math.max(b.len, y));
                m && !e && b.series.forEach(function(a) {
                ...
                e = D(k.minTickInterval, b.isDatetimeAxis && b.closestPointRange);
                !h && b.tickInterval < e && (b.tickInterval = e);
                c || g || h || (b.tickInterval = t(b.tickInterval, null, n(b.tickInterval), D(k.allowDecimals, !(.5 < b.tickInterval && 5 > b.tickInterval && 1E3 < b.max && 9999 > b.max)), !!this.tickAmount));
            ...
            setTickPositions: function() {
                ...
                this.single = this.min === this.max && w(this.min) && !this.tickAmount && (parseInt(this.min, 10) === this.min || !1 !== e.allowDecimals);
                ...
                !b && (!this.ordinalPositions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200) ? (b = [this.min, this.max], a.error(19, !1, this.chart)) : b = this.isDatetimeAxis ? this.getTimeTicks(this.normalizeTimeTickInterval(this.tickInterval, e.units), this.min, this.max, e.startOfWeek, this.ordinalPositions, this.closestPointRange, !0) : this.isLog ? this.getLogTickPositions(this.tickInterval, this.min, this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max), b.length > this.len && (b = [b[0], b.pop()], b[0] ===
                    b[1] && (b.length = 1)), this.tickPositions = b, f && (f = f.apply(this, [this.min, this.max]))) && (this.tickPositions = b = f);
                this.paddedTicks = b.slice(0);
                this.trimTicks(b, l, g);
                this.isLinked || (this.single && 2 > b.length && (this.min -= .5, this.max += .5), k || f || this.adjustTickAmount());
            ...
            alignToOthers: function() {
                var a = {},
                    b, k = this.options;
                !1 === this.chart.options.chart.alignTicks || !1 === k.alignTicks || !1 === k.startOnTick || !1 === k.endOnTick || this.isLog || this.chart[this.coll].forEach(function(e) {
                    var k = e.options,
                        k = [e.horiz ? k.left : k.top, k.width, k.height, k.pane].join();
                    e.series.length && (a[k] ? b = !0 : a[k] = 1)
                });
                return b
            },
            getTickAmount: function() {
                ...
                !w(a.tickInterval) &&
                    this.len < k && !this.isRadial && !this.isLog && a.startOnTick && a.endOnTick && (b = 2);
                !b && this.alignToOthers() && (b = Math.ceil(this.len / k) + 1);
            ...
            adjustTickAmount: function() {
                ...
                if (this.hasData()) {
                    if (l < f) {
                        for (n = this.min; k.length < f;) k.length % 2 || n === g ? k.push(r(k[k.length - 1] + b)) : k.unshift(r(k[0] - b));
                        this.transA *= (l -
                            1) / (f - 1);
                    ...
                    if (w(d)) {
                        for (b = a = k.length; b--;)(3 === d && 1 === b % 2 || 2 >= d && 0 < b && b < a - 1) && k.splice(b, 1);
            ...
            zoom: function(a, b) {
                ...
                d(this, "zoom", a, function(a) {
                    var b = a.newMin,
                        f = a.newMax;
                    if (b !== this.min || f !== this.max) this.allowZoomOutside || (w(e) && (b < l && (b = l), b > q && (b = q)), w(k) && (f < l && (f = l), f > q && (f = q))), this.displayBtn = void 0 !== b ||
                        void 0 !== f, this.setExtremes(b, f, !1, void 0, {
                            trigger: "zoom"
                        });
                    a.zoomed = !0
                });
            ...
            setAxisSize: function() {
                var e = this.chart,
                    ...
                    b = this.left = Math.round(a.relativeLength(D(b.left, e.plotLeft +
                        k[3]), e.plotWidth, e.plotLeft));
                this.bottom = e.chartHeight - l - g;
                this.right = e.chartWidth - d - b;
                this.len = Math.max(f ? d : l, 0);
                this.pos = f ? b : g
            },
            ...
            getThreshold: function(a) {
                ...
                null === a || -Infinity === a ? a = b : Infinity === a ?
                    a = e : b > a ? a = b : e < a && (a = e);
                return this.translate(a, 0, 1, 0, 1)
            },
            autoLabelAlign: function(a) {
                var e = (D(a, 0) - 90 * this.side + 720) % 360;
                a = {
                    align: "center"
                };
            ...
            tickSize: function(a) {
                var e = this.options,
                    ...
                    f;
                k && b && ("inside" === e[a + "Position"] && (b = -b), f = [b, k]);
                a = {
                    tickSize: f
                };
            ...
            unsquish: function() {
                var a = this.options.labels,
                    ...
                    l, g = a.rotation,
                    n = this.labelMetrics(),
                    c, t = Number.MAX_VALUE,
                    m, v = this.max - this.min,
                    E = function(a) {
                        var b = a / (d || 1),
                            b = 1 < b ? Math.ceil(b) : 1;
                        b * k > v && Infinity !== a && Infinity !== d && (b = Math.ceil(v / k));
                        return r(b * k)
                    };
                b ? (m = !a.staggerLines && !a.step && (w(g) ? [g] : d < D(a.autoRotationLimit, 80) && a.autoRotation)) && m.forEach(function(a) {
                    var b;
                    if (a === g || a && -90 <= a && 90 >= a) c = E(Math.abs(n.h / Math.sin(x * a))), b = c + Math.abs(a / 360), b < t && (t = b, l = a, f = c)
                }) : a.step || (f = E(n.h));
                this.autoRotation = m;
            ...
            getSlotWidth: function(a) {
                var b = this.chart,
                    ...
                    d = b.margin[3];
                return a && a.slotWidth || e && 2 > (k.step || 0) && !k.rotation && (this.staggerLines ||
            ...
            renderUnsquish: function() {
                var a = this.chart,
                    ...
                    C, p, h = 0,
                    y;
                f(l.rotation) || (m.rotation = l.rotation || 0);
                k.forEach(function(a) {
                    (a = d[a]) && a.label && a.label.textPxLength > h && (h = a.label.textPxLength)
                });
                this.maxLabelLength = h;
                if (this.autoRotation) h > t && h > v.h ? m.rotation = this.labelRotation : this.labelRotation = 0;
                else if (c && (C = t, !E))
                    for (p = "clip", t = k.length; !n && t--;)
                        if (y = k[t], y = d[y].label) y.styles && "ellipsis" === y.styles.textOverflow ? y.css({
                            textOverflow: "clip"
                        }) : y.textPxLength > c && y.css({
                            width: c + "px"
                        }), y.getBBox().height > this.len / k.length - (v.h - v.f) && (y.specificTextOverflow = "ellipsis");
                m.rotation && (C = h > .5 * a.chartHeight ? .33 * a.chartHeight : h, E || (p = "ellipsis"));
                if (this.labelAlign = l.align || this.autoLabelAlign(this.labelRotation)) m.align =
                    this.labelAlign;
                k.forEach(function(a) {
                    var b = (a = d[a]) && a.label,
                        e = g.width,
                        k = {};
                    b && (b.attr(m), a.shortenLabel ? a.shortenLabel() : C && !e && "nowrap" !== g.whiteSpace && (C < b.textPxLength || "SPAN" === b.element.tagName) ? (k.width = C, E || (k.textOverflow = b.specificTextOverflow || p), b.css(k)) : b.styles && b.styles.width && !k.width && !e && b.css({
                        width: null
            ...
            addTitle: function(a) {
                var b = this.chart.renderer,
                    ...
                    d, l = this.chart.styledMode;
                this.axisTitle || ((d = f.textAlign) || (d = (e ? {
                        low: "left",
                        middle: "center",
                        high: "right"
                    } : {
                        ...
                        align: d
                    }).addClass("highcharts-axis-title"), l || this.axisTitle.css(v(f.style)),
                    this.axisTitle.add(this.axisGroup), this.axisTitle.isNew = !0);
                l || f.style.width || this.isRadial || this.axisTitle.css({
                    width: this.len
                });
            ...
            getOffset: function() {
                var a = this,
                    ...
                    z = a.axisParent;
                m = a.hasData();
                a.showAxis = v = m || D(f.showEmpty, !0);
                a.staggerLines = a.horiz && y.staggerLines;
                a.axisGroup || (a.gridGroup = k.g("grid").attr({
                    zIndex: f.gridZIndex || 1
                }).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (u || "")).add(z), a.axisGroup = k.g("axis").attr({
                    zIndex: f.zIndex || 2
                }).addClass("highcharts-" + this.coll.toLowerCase() + " " + (u || "")).add(z), a.labelGroup = k.g("axis-labels").attr({
                    zIndex: y.zIndex || 7
                ...
                m || a.isLinked ?
                    (l.forEach(function(b, e) {
                        ...
                        1: "left",
                        3: "right"
                    } [c] === a.labelAlign, D(y.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) && l.forEach(function(a) {
                        A = Math.max(g[a].getLabelSize(), A)
                    }), a.staggerLines && (A *= a.staggerLines), a.labelOffset = A * (a.opposite ? -1 : 1)) : H(g, function(a, b) {
                        a.destroy();
                        delete g[b]
                    });
                h && h.text && !1 !== h.enabled && (a.addTitle(v), v && !1 !== h.reserveSpace && (a.titleOffset = E = a.axisTitle.getBBox()[n ? "height" :
                    "width"], C = h.offset, p = w(C) ? 0 : D(h.margin, n ? 5 : 10)));
                a.renderLine();
                a.offset = x * D(f.offset, r[c]);
                a.tickRotCorr = a.tickRotCorr || {
                    x: 0,
                    y: 0
                };
                k = 0 === c ? -a.labelMetrics().h : 2 === c ? a.tickRotCorr.y : 0;
                p = Math.abs(A) + p;
                A && (p = p - k + x * (n ? D(y.y, a.tickRotCorr.y + 8 * x) : y.x));
                a.axisTitleMargin = D(C, p);
                a.getMaxLabelDimensions && (a.maxLabelDimensions = a.getMaxLabelDimensions(g, l));
                n = this.tickSize("tick");
                r[c] = Math.max(r[c], a.axisTitleMargin + E + x * a.offset, p, m && l.length && n ? n[0] + x * a.offset : 0);
                f = f.offset ? 0 : 2 * Math.floor(a.axisLine.strokeWidth() /
                    2);
                b[t] = Math.max(b[t], f);
            ...
            getLinePath: function(a) {
                var b = this.chart,
                    ...
                    k = b.chartHeight - this.bottom - (e ? this.height : 0) + k;
                e && (a *= -1);
                return b.renderer.crispLine(["M", f ? this.left : d, f ? k : this.top, "L", f ? b.chartWidth - this.right : d, f ? k : b.chartHeight - this.bottom], a)
            },
            renderLine: function() {
            ...
            getTitlePosition: function() {
                var a = this.horiz,
                    ...
                    b = (a ? k + this.height : b) + (a ? 1 : -1) * (n ? -1 : 1) * this.axisTitleMargin + [-v,
                        v, E.f, -v
                    ][this.side],
                    a = {
                        x: a ? f + t : b + (n ? this.width : 0) + c + t,
                        y: a ? b + m - (n ? this.height : 0) + c : f + m
                    };
            ...
            renderTick: function(a, b) {
                ...
                if (!e || a >= this.min && a <= this.max) k[a] || (k[a] = new C(this, a)), f && k[a].isNew &&
            ...
            render: function() {
                ...
                if (b.hasData() || n) b.minorTickInterval && !b.categories && b.getMinorTickPositions().forEach(function(a) {
                    ...
                    c.length && (c.forEach(function(a, e) {
                        ...
                        w = void 0 !== c[f + 1] ? c[f + 1] + A : b.max - A;
                        0 === f % 2 && e < b.max && w <= b.max + (k.polar ? -A : A) && (p[e] || (p[e] = new a.PlotLineOrBand(b)), u = e + A, p[e].options = {
                            from: g ? b.lin2log(u) : u,
                            to: g ? b.lin2log(w) : w,
                            color: y
                        }, p[e].render(), p[e].isActive = !0)
                ...
                }), D.isPlaced = !0, D[r ? "show" : "hide"](!0));
                t && r && (f = b.getTitlePosition(), l(f.y) ? (t[t.isNew ? "attr" : "animate"](f), t.isNew = !1) : (t.attr("y", -9999), t.isNew = !0));
            ...
            drawCrosshair: function(a, b) {
                ...
                if (this.crosshair && !1 !== (w(b) || !f)) {
                    f ? w(b) &&
                        (l = D(b.crosshairPos, this.isXAxis ? b.plotX : this.len - b.plotY)) : l = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos);
                    w(l) && (e = this.getPlotLinePath(b && (this.isXAxis ? b.x : D(b.stackY, b.y)), null, null, null, l) || null);
                    if (!w(e)) {
                        this.hideCrosshair();
                        return
                    }
                    f = this.categories && !this.isRadial;
                    g || (this.cross = g = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (f ? "category " : "thin ") + k.className).attr({
                        zIndex: D(k.zIndex, 2)
                    }).add(), this.chart.styledMode || (g.attr({
                        stroke: k.color ||
                            (f ? c("#ccd6eb").setOpacity(.25).get() : "#cccccc"),
                        "stroke-width": D(k.width, 1)
                    }).css({
                        "pointer-events": "none"
                    }), k.dashStyle && g.attr({
    ...
    (function(a) {
        ...
        z.prototype.normalizeTimeTickInterval = function(a, r) {
            ...
            var w = h[r[0]],
                x = r[1],
                p;
            for (p = 0; p < c.length && !(r = c[p], w = h[r[0]], x = r[1], c[p + 1] && a <= (w * x[x.length - 1] + h[c[p + 1][0]]) / 2); p++);
            w ===
                h.year && a < 5 * w && (x = [1, 2, 5]);
            a = G(a / w, x, "year" === r[0] ? Math.max(F(a / w), 1) : 1);
            return {
                unitRange: w,
                count: a,
                unitName: r[0]
    ...
    (function(a) {
        var z = a.Axis,
            ...
            G = a.normalizeTickInterval,
            h = a.pick;
        z.prototype.getLogTickPositions = function(a, r, u, w) {
            var c = this.options,
                p = this.len,
                g = [];
            w || (this._minorAutoInterval = null);
            if (.5 <= a) a = Math.round(a), g = this.getLinearTickPositions(a, r, u);
            else if (.08 <= a)
                for (var p = Math.floor(r), d, m, n, b, l, c = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; p < u + 1 && !l; p++)
                    for (m =
                        c.length, d = 0; d < m && !l; d++) n = this.log2lin(this.lin2log(p) * c[d]), n > r && (!w || b <= u) && void 0 !== b && g.push(b), b > u && (l = !0), b = n;
            else r = this.lin2log(r), u = this.lin2log(u), a = w ? this.getMinorTickInterval() : c.tickInterval, a = h("auto" === a ? null : a, this._minorAutoInterval, c.tickPixelInterval / (w ? 5 : 1) * (u - r) / ((w ? p / this.tickPositions.length : p) || 1)), a = G(a, null, F(a)), g = this.getLinearTickPositions(a, r, u).map(this.log2lin), w || (this._minorAutoInterval = a / 5);
    ...
    (function(a, z) {
        ...
        a.PlotLineOrBand.prototype = {
            render: function() {
                ...
                var c = this,
                    ...
                    C = d.events,
                    A = {
                        "class": "highcharts-plot-" + (v ? "band " : "line ") + (d.className || "")
                    },
                    y = {},
                    e = p.chart.renderer,
                    q = v ? "bands" : "lines";
                p.isLog && (l = p.log2lin(l), b = p.log2lin(b), f = p.log2lin(f));
                p.chart.styledMode || (t ? (A.stroke = k, A["stroke-width"] = d.width, d.dashStyle && (A.dashstyle = d.dashStyle)) : v && (k && (A.fill = k), d.borderWidth && (A.stroke = d.borderColor, A["stroke-width"] = d.borderWidth)));
                y.zIndex = E;
                q += "-" + E;
                (k = p.plotLinesAndBandsGroups[q]) || (p.plotLinesAndBandsGroups[q] = k = e.g("plot-" + q).attr(y).add());
                D && (c.svgElem = H = e.path().attr(A).add(k));
                if (t) A = p.getPlotLinePath(f, H.strokeWidth());
                else if (v) A = p.getPlotBandPath(l, b, d);
                else return;
                D && A && A.length ? (H.attr({
                    d: A
                ...
                })) : H && (A ? (H.show(), H.animate({
                    d: A
                })) : (H.hide(), n && (c.label = n = n.destroy())));
                m && h(m.text) && A && A.length && 0 < p.width && 0 < p.height && !A.isFlat ? (m = u({
                    align: g && v && "center",
                    x: g ? !v && 4 : 10,
                    verticalAlign: !g && v && "middle",
                    y: g ? v ? 16 : 10 : v ? 6 : -4,
                    rotation: g && !v && 90
                }, m), this.renderLabel(m, A, v, E)) : n && n.hide();
                return c
            },
            renderLabel: function(a,
                ...
                }, m.zIndex = d, this.label = m = n.text(a.text, 0, 0, a.useHTML).attr(m).add(), this.axis.chart.styledMode || m.css(a.style));
        ...
        a.extend(z.prototype, {
            getPlotBandPath: function(a, c) {
                ...
                if (d && g)
                    for (a && (l = d.toString() === g.toString(), b = 0), a = 0; a < d.length; a += 6) n && g[a + 1] === d[a + 1] ? (g[a + 1] += b, g[a + 4] += b) : n || g[a + 2] !== d[a + 2] || (g[a + 2] += b, g[a + 5] += b), m.push("M", d[a + 1], d[a + 2], "L", d[a + 4], d[a + 5], g[a + 4], g[a + 5], g[a + 1], g[a + 2], "z"), m.isFlat = l;
                return m
            },
            ...
            addPlotBandOrLine: function(c, p) {
                var g = (new a.PlotLineOrBand(this, c)).render(),
                    d = this.userOptions;
                g && (p && (d[p] = d[p] || [], d[p].push(c)), this.plotLinesAndBands.push(g));
                return g
            },
        ...
        a.Tooltip.prototype = {
            ...
            cleanSplit: function(a) {
                this.chart.series.forEach(function(g) {
                    var d = g && g.tt;
                    d && (!d.isActive || a ? g.tt = d.destroy() : d.isActive = !1)
                })
            },
            ...
            getLabel: function() {
                ...
                this.label || (this.outside && (this.container = n = a.doc.createElement("div"), n.className = "highcharts-tooltip-container", a.css(n, {
                    ...
                    g = new a.Renderer(n, 0, 0)), this.split ? this.label = g.g("tooltip") : (this.label = g.label("", 0, 0, m.shape || "callout", null, null, m.useHTML, null, "tooltip").attr({
                    padding: m.padding,
                    r: m.borderRadius
                }), d || this.label.attr({
                    fill: m.backgroundColor,
                    "stroke-width": m.borderWidth
                }).css(m.style).shadow(m.shadow)), d && (this.applyFilter(), this.label.addClass("highcharts-tooltip-" + this.chart.index)), this.outside && (b = {
            ...
            getAnchor: function(a, c) {
                ...
                this.followPointer && c ? (void 0 === c.chartX && (c = g.normalize(c)), a = [c.chartX - d.plotLeft, c.chartY - b]) : a[0].tooltipPos ? a = a[0].tooltipPos : (a.forEach(function(a) {
                    t = a.series.yAxis;
                    h = a.series.xAxis;
                    f += a.plotX + (!n && h ? h.left - l : 0);
                    v += (a.plotLow ? (a.plotLow + a.plotHigh) / 2 : a.plotY) +
                        (!n && t ? t.top - b : 0)
                }), f /= a.length, v /= a.length, a = [n ? d.plotWidth - v : f, this.shared && !n && 1 < a.length && c ? c.chartY - b : n ? d.plotHeight - f : v]);
            ...
            getPosition: function(a, c, d) {
                var g = this.chart,
                    ...
                    C = function(a, e, k, f, d, c) {
                        ...
                        else if (g) b[a] = Math.min(c - k, 0 > t - l ? t : t - l);
                        else if (q) b[a] = Math.max(d, f + l + k > e ? f : f + l);
                        else return !1
                    },
                    y = function(a, e, k, f) {
                        var d;
                        f < n || f > e - n ? d = !1 : b[a] = f < k / 2 ? 1 : f > e - k / 2 ? e - k - 2 : f - k / 2;
                        return d
                    },
                    e = function(a) {
                        var b = A;
            ...
            refresh: function(c, g) {
                var d, m = this.options,
                    n, b = c,
                    l, f = {},
                    v = [];
                d = m.formatter || this.defaultFormatter;
                var f = this.shared,
                    t, h = this.chart.styledMode;
                m.enabled &&
                    (a.clearTimeout(this.hideTimer), this.followPointer = u(b)[0].series.tooltipOptions.followPointer, l = this.getAnchor(b, g), g = l[0], n = l[1], !f || b.series && b.series.noSharedTooltip ? f = b.getLabelConfig() : (b.forEach(function(a) {
                        a.setState("hover");
                        v.push(a.getLabelConfig())
                    }), f = {
                        x: b[0].category,
                        y: b[0].y
                    }, f.points = v, b = b[0]), this.len = v.length, f = d.call(f, this), t = b.series, this.distance = r(t.tooltipOptions.distance, 16), !1 === f ? this.hide() : (d = this.getLabel(), this.isHidden && d.attr({
                        opacity: 1
                    }).show(), this.split ? this.renderSplit(f,
                        u(c)) : (m.style.width && !h || d.css({
            ...
            renderSplit: function(c, g) {
                ...
                c.slice(0, g.length + 1).forEach(function(a, k) {
                    if (!1 !== a && "" !== a) {
                        ...
                        var c = k.series || d,
                            C = c.tt,
                            y = k.series || {},
                            e = "highcharts-color-" + r(k.colorIndex, y.colorIndex, "none");
                        C || (C = {
                            padding: f.padding,
                            r: f.borderRadius
                        }, n.styledMode || (C.fill = f.backgroundColor, C.stroke = f.borderColor || k.color || y.color || "#333333", C["stroke-width"] = f.borderWidth), c.tt = C = b.label(null, null, null, (k.isHeader ? f.headerShape : f.shape) || "callout", null, null,
                            f.useHTML).addClass("highcharts-tooltip-box " + e).attr(C).add(h));
                        C.isActive = !0;
                        C.attr({
                            text: a
                        });
                        n.styledMode || C.css(f.style).shadow(f.shadow);
                        a = C.getBBox();
                        y = a.width + C.strokeWidth();
                        k.isHeader ? (v = a.height, n.xAxis[0].opposite && (t = !0, p -= v), y = Math.max(0, Math.min(k.plotX + n.plotLeft - y / 2, n.chartWidth + (n.scrollablePixels ? n.scrollablePixels - n.marginRight : 0) - y))) : y = k.plotX + n.plotLeft - r(f.distance, 16) - y;
                        0 > y && (l = !1);
                        a = (k.series && k.series.yAxis && k.series.yAxis.pos) + (k.plotY || 0);
                        a -= p;
                        k.isHeader && (a = t ? -v : n.plotHeight +
                            v);
                        m.push({
                            target: a,
                            rank: k.isHeader ? 1 : 0,
                ...
                a.distribute(m, n.plotHeight + v);
                m.forEach(function(a) {
                    var b = a.point,
                        c = b.series;
                    a.tt.attr({
                        visibility: void 0 === a.pos ? "hidden" : "inherit",
                        x: l || b.isHeader || f.positioner ? a.x : b.plotX + n.plotLeft + d.distance,
                        y: a.pos + p,
                        anchorX: b.isHeader ? b.plotX + n.plotLeft : b.plotX + c.xAxis.pos,
                        anchorY: b.isHeader ? n.plotTop + n.plotHeight / 2 : b.plotY + c.yAxis.pos
                    })
                })
            },
            updatePosition: function(a) {
                ...
                a = a.plotY + c.plotTop;
                var b;
                this.outside && (b = (this.options.borderWidth || 0) + 2 * this.distance, this.renderer.setSize(d.width + b, d.height + b, !1), n += c.pointer.chartPosition.left - m.x, a += c.pointer.chartPosition.top - m.y);
                this.move(Math.round(m.x), Math.round(m.y || 0),
                    n, a)
            },
            getDateFormat: function(a, c, d, m) {
                ...
                for (f in x) {
                    ...
                    if (v[f] && b.substr(v[f]) !== "01-01 00:00:00.000".substr(v[f])) break;
                    "week" !== f && (t = f)
                }
            ...
            tooltipFooterHeaderFormatter: function(c, g) {
                ...
                a.fireEvent(this, "headerFormatter", g, function(a) {
                    f && !b && (b = this.getXDateFormat(c, n, l));
                    f && b && (c.point && c.point.tooltipDateKeys || ["key"]).forEach(function(a) {
                        v = v.replace("{point." + a + "}", "{point." + a + ":" + b + "}")
                    });
                    m.chart.styledMode &&
                        (v = this.styledModeFormat(v));
                    a.text = G(v, {
                        point: c,
                        series: m
                    }, this.chart.time)
    ...
    (function(a) {
        ...
        a.Pointer.prototype = {
            ...
            findNearestKDPoint: function(a, b, d) {
                ...
                a.forEach(function(a) {
                    ...
                    if ((l = g(a, !0)) && !(l = !g(f, !0))) var l = f.distX - a.distX,
                        ...
                        l = 0 < (0 !== l && b ? l : 0 !== c ? c : 0 !== k ? k : f.series.index > a.series.index ?
                            -1 : 1);
                    l && (f = a)
                });
                return f
            ...
            getHoverData: function(a, b, d, c, n, h) {
                var f, k = [];
                c = !(!c || !a);
                var l = b && !b.stickyTracking ? [b] : d.filter(function(a) {
                    return a.visible &&
                        !(!n && a.directTouch) && m(a.options.enableMouseTracking, !0) && a.stickyTracking
                });
                b = (f = c ? a : this.findNearestKDPoint(l, n, h)) && f.series;
                f && (n && !b.noSharedTooltip ? (l = d.filter(function(a) {
            ...
            runPointActions: function(b,
                ...
                this.unDocMouseMove || (this.unDocMouseMove = z(d.container.ownerDocument, "mousemove", function(b) {
                    ...
                    if (k) k.pointer.onDocumentMouseMove(b)
                }));
            ...
            drag: function(a) {
                var b = this.chart,
                    ...
                    C = b.plotWidth,
                    y = b.plotHeight,
                    e, q = this.selectionMarker,
                    p = this.mouseDownX,
                    r = this.mouseDownY,
                    u = d.panKey && a[d.panKey + "Key"];
                q && q.touch || (c < k ? c = k : c > k + C && (c = k + C), l < m ? l = m : l > m + y && (l = m + y), this.hasDragged = Math.sqrt(Math.pow(p - c, 2) + Math.pow(r - l, 2)), 10 < this.hasDragged && (e = b.isInsidePlot(p - k, r - m), b.hasCartesianSeries && (this.zoomX || this.zoomY) && e && !u && !q && (this.selectionMarker = q = b.renderer.rect(k, m, g ? 1 : C, n ? 1 : y, 0).attr({
            ...
            onContainerMouseMove: function(b) {
                var f = this.chart;
                r(a.hoverChartIndex) && G[a.hoverChartIndex] && G[a.hoverChartIndex].mouseIsDown || (a.hoverChartIndex = f.index);
                b = this.normalize(b);
                b.returnValue = !1;
            ...
            onContainerClick: function(a) {
                ...
                a = this.normalize(a);
                b.cancelClick ||
                    (d && this.inClass(a.target, "highcharts-tracker") ? (x(d.series, "click", u(a, {
                        point: d
                    })), b.hoverPoint && d.firePointEvent("click", a)) : (u(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - c, a.chartY - l) && x(b, "click", a)))
            },
            setDOMEvents: function() {
                ...
                a.unbindDocumentMouseUp || (a.unbindDocumentMouseUp = z(d, "mouseup", b.onDocumentMouseUp));
    ...
    (function(a) {
        ...
        F(a.Pointer.prototype, {
            pinchTranslate: function(a, h, u, w, x, p) {
                this.zoomHor && this.pinchTranslateDirection(!0, a, h, u, w, x, p);
                this.zoomVert && this.pinchTranslateDirection(!1, a, h, u, w, x, p)
            },
            pinchTranslateDirection: function(a, h, u, w, x, p, g, d) {
                var c = this.chart,
                    n = a ? "x" : "y",
                    b = a ? "X" : "Y",
                    l = "chart" + b,
                    ...
                    L;
                u = function() {
                    !E && 20 < Math.abs(C - e) && (D = d || Math.abs(y - q) / Math.abs(C - e));
                    r = (v - y) / D + C;
                    t = c["plot" + (a ? "Width" : "Height")] / D
                };
                u();
                h = r;
                h < k.min ? (h = k.min, L = !0) : h + t > k.max && (h = k.max - t, L = !0);
                L ? (y -= .8 * (y - g[n][0]), E || (q -= .8 * (q - g[n][1])), u()) : g[n] = [y, q];
                A || (p[n] = r - v, p[f] = t);
                p = A ? 1 / D : D;
                x[f] = t;
                x[n] = h;
                w[A ? a ? "scaleY" : "scaleX" : "scale" + b] = D;
                w["translate" + b] = p * v + (y - p * C)
            },
            pinch: function(a) {
                var c =
                    this,
                ...
                "touchstart" === a.type ? ([].forEach.call(x, function(a, b) {
                    ...
                    if (a.zoomEnabled) {
                        ...
                        b.max = Math.max(a.pos + a.len, g + f)
                    }
                }), c.res = !0) : c.followTouchMove && 1 === p ? this.runPointActions(c.normalize(a)) : w.length && (m || (c.selectionMarker = m = F({
                    destroy: G,
                    touch: !0
                }, u.plotBox)), c.pinchTranslate(w, x, n, m, l, g), c.hasPinched = d, c.scaleGroups(n, l), c.res && (c.res = !1, this.reset(!1, 0)))
            },
            touch: function(c, r) {
                var u = this.chart,
                    w, x;
                ...
                1 === c.touches.length ? (c = this.normalize(c), (x = u.isInsidePlot(c.chartX - u.plotLeft, c.chartY - u.plotTop)) && !u.openMenu ? (r && this.runPointActions(c), "touchmove" === c.type && (r = this.pinchDown, w = r[0] ? 4 <= Math.sqrt(Math.pow(r[0].chartX - c.chartX, 2) + Math.pow(r[0].chartY - c.chartY, 2)) : !1), h(w, !0) && this.pinch(c)) : r && this.reset()) : 2 === c.touches.length && this.pinch(c)
            },
    ...
    (function(a) {
        ...
        if (!a.hasTouch && (x.PointerEvent || x.MSPointerEvent)) {
            var g = {},
                ...
                n = function(b, d, f, c) {
                    "touch" !== b.pointerType && b.pointerType !== b.MSPOINTER_TYPE_TOUCH || !F[a.hoverChartIndex] || (c(b), c = F[a.hoverChartIndex].pointer, c[d]({
                        type: f,
        ...
        a.Legend.prototype = {
            ...
            colorizeItem: function(a, b) {
                ...
                if (!this.chart.styledMode) {
                    ...
                    n && (p && n.isMarker && (k = a.pointAttribs(), b || (k.stroke = k.fill = m)), n.attr(k))
                }
            ...
            positionCheckboxes: function() {
                ...
                a && (b = a.translateY, this.allItems.forEach(function(c) {
                    var g = c.checkbox,
                        l;
                    g && (l = b + f + g.y + (this.scrollOffset || 0) + 3, F(g, {
            ...
            renderItem: function(a) {
                ...
                E || (a.legendGroup = d.g("legend-item").addClass("highcharts-" + y.type + "-series highcharts-color-" + a.colorIndex + (p ? " " + p : "") + (C ? " highcharts-series-" + a.index : "")).attr({
                        zIndex: 1
                    }).add(this.scrollGroup),
                    a.legendItem = E = d.text("", k ? c + g : -g, this.baseline || 0, q), b.styledMode || E.css(w(a.visible ? n : m)), E.attr({
                        align: k ? "left" : "right",
                        zIndex: 2
                    }).add(a.legendGroup), this.baseline || (this.fontMetrics = d.fontMetrics(b.styledMode ? 12 : n.fontSize, E), this.baseline = this.fontMetrics.f + 3 + this.itemMarginTop, E.attr("y", this.baseline)), this.symbolHeight = f.symbolHeight || this.fontMetrics.f, y.drawLegendSymbol(this, a), this.setItemEvents && this.setItemEvents(a, E, q), e && this.createCheckboxForItem(a));
                this.colorizeItem(a, a.visible);
                !b.styledMode && n.width || E.css({
                    width: (f.itemWidth || this.widthOption || b.spacingBox.width) - h
                });
                this.setText(a);
                b = E.getBBox();
            ...
            layoutItem: function(a) {
                ...
                f && this.itemX - d + b > h && (this.itemX = d, this.itemY += n + this.lastLineHeight + g, this.lastLineHeight = 0);
                this.lastItemY = n + this.itemY + g;
                this.lastLineHeight = Math.max(c, this.lastLineHeight);
                a._legendItemPos = [this.itemX, this.itemY];
                f ? this.itemX += b : (this.itemY += n + c + g, this.lastLineHeight = c);
                this.offsetWidth = this.widthOption || Math.max((f ? this.itemX - d - (a.checkbox ? 0 : m) : b) + d, this.offsetWidth)
            },
            getAllItems: function() {
                var a = [];
                this.chart.series.forEach(function(b) {
                    var d = b && b.options;
                    b && x(d.showInLegend, h(d.linkedTo) ? !1 : void 0, !0) && (a = a.concat(b.legendItems || ("point" === d.legendType ? b.data : b)))
                });
            ...
            proximatePositions: function() {
                ...
                this.allItems.forEach(function(f) {
                    var g, l;
                    g = c;
                    f.xAxis && f.points && (f.xAxis.options.reversed && (g = !g), g = a.find(g ? f.points : f.points.slice(0).reverse(),
                        function(b) {
            ...
            render: function() {
                ...
                this.widthOption = a.relativeLength(r.width,
                    d.spacingBox.width - A);
                m = d.spacingBox.width - 2 * A - r.x; - 1 < ["rm", "lm"].indexOf(this.getAlignment().substring(0, 2)) && (m /= 2);
                ...
                f = (this.widthOption || this.offsetWidth) + A;
                h = this.lastItemY + this.lastLineHeight + this.titleHeight;
                h = this.handleOverflow(h);
                h += A;
                p || (this.box = p = b.rect().addClass("highcharts-legend-box").attr({
                    r: r.borderRadius
                }).add(c), p.isNew = !0);
                d.styledMode || p.attr({
                ...
                0 < f && 0 < h && (p[p.isNew ? "attr" : "animate"](p.crisp.call({}, {
                    x: 0,
                    y: 0,
                    width: f,
                    height: h
                ...
                p[m ? "show" : "hide"]();
                d.styledMode && "none" === c.getStyle("display") && (f = h = 0);
                this.legendWidth = f;
                this.legendHeight = h;
                m && (b = d.spacingBox, /(lth|ct|rth)/.test(this.getAlignment()) && (b = w(b, {
            ...
            handleOverflow: function(a) {
                ...
                "horizontal" !== c.layout || "middle" === c.verticalAlign ||
                    c.floating || (g /= 2);
                n && (g = Math.min(g, n));
                q.length = 0;
                a > g && !1 !== E.enabled ? (this.clipHeight = h = Math.max(g - 20 - this.titleHeight - m, 0), this.currentPage = x(this.currentPage, 1), this.fullHeight = a, r.forEach(function(a, b) {
                        var e = a._legendItemPos[1],
                            d = Math.round(a.legendItem.getBBox().height),
                            k = q.length;
                        if (!k || e - q[k - 1] > h && (p || e) !== q[k - 1]) q.push(p || e), k++;
                        a.pageIx = k - 1;
                        p && (r[b - 1].pageIx = k - 1);
                        b === r.length - 1 && e + d - q[k - 1] > h && e !== p && (q.push(e), a.pageIx = k);
                        e !== p && (p = e)
                    }), k || (k = b.clipRect = f.clipRect(0, m, 9999, 0), b.contentGroup.clip(k)),
                    u(h), e || (this.nav = e = f.g().attr({
                        zIndex: 1
                    }).add(this.group), this.up = f.symbol("triangle", 0, 0, y, y).on("click", function() {
                        b.scroll(-1, C)
                        ...
                        b.scroll(1, C)
                    }).add(e)), b.scroll(0), a = g) : e && (u(), this.nav = e.destroy(), this.scrollGroup.attr({
                    translateY: 1
                }), this.clipHeight = 0);
                return a
            },
        ...
        a.LegendSymbolMixin = {
            drawRectangle: function(a, b) {
                ...
                b.legendSymbol = this.chart.renderer.rect(f ? (a.symbolWidth - d) /
                    2 : 0, a.baseline - d + 1, f ? d : a.symbolWidth, d, x(a.options.symbolRadius, d / 2)).addClass("highcharts-point").attr({
                    zIndex: 3
                }).add(b.legendGroup)
            },
            drawLineMarker: function(a) {
                ...
                this.legendLine = m.path(["M", 0, a, "L", f, a]).addClass("highcharts-graph").attr(h).add(n);
                d && !1 !== d.enabled && f && (b = Math.min(x(d.radius, g), g), 0 === this.symbol.indexOf("url") && (d = w(d, {
                    width: c,
                    height: c
                }), b = 0), this.legendSymbol = d = m.symbol(this.symbol, f / 2 - b, a - b, 2 * b, 2 * b, d).addClass("highcharts-point").add(n), d.isMarker = !0)
            }
        };
        ...
        m(T.prototype, {
            ...
            init: function(e, d) {
                ...
                b(this, "init", {
                    ...
                    e.series = null;
                    k = D(w, e);
                    for (f in k.plotOptions) k.plotOptions[f].tooltip = g[f] && D(g[f].tooltip) || void 0;
                    k.tooltip.userOptions = e.chart && e.chart.forExport && e.tooltip.userOptions || e.tooltip;
                    k.series = e.series = c;
                    this.userOptions = e;
                    var q = k.chart,
                        l = q.events;
            ...
            redraw: function(e) {
                ...
                for (e = k.length; e--;)
                    ...
                    for (e = k.length; e--;) C = k[e], C.options.stacking && (C.isDirty = !0);
                k.forEach(function(a) {
                ...
                h && (d.forEach(function(a) {
                    ...
                    var e = a.min + "," + a.max;
                    a.extKey !== e && (a.extKey = e, y.push(function() {
            ...
            get: function(a) {
                ...
                var e, d = this.series,
                    k;
                e = n(this.axes, b) || n(this.series, b);
                for (k = 0; !e && k < d.length; k++) e = n(d[k].points || [], b);
                return e
            },
            getAxes: function() {
                var a = this,
            ...
            setTitle: function(a, b, e) {
                ...
                [
                    ...
                    a = a[2];
                    k && c && (d[e] = k = k.destroy());
                    a && !k && (d[e] = d.renderer.text(a.text, 0, 0, a.useHTML).attr({
                        align: a.align,
                        "class": "highcharts-" + e,
                        zIndex: a.zIndex || 4
            ...
            layOutTitles: function(a) {
                ...
                ["title", "subtitle"].forEach(function(a) {
                    var e = this[a],
                        f = this.options[a];
                    a = "title" === a ? -3 : f.verticalAlign ?
                        0 : b + 2;
                    var c;
                    e && (this.styledMode || (c = f.style.fontSize), c = d.fontMetrics(c, e).b, e.css({
                        width: (f.width || k.width + f.widthAdjust) + "px"
                    }).align(m({
                        y: a + c
                    }, f), !1, "spacingBox"), f.floating || f.verticalAlign || (b = Math.ceil(b + e.getBBox(f.useHTML).height)))
                }, this);
                e = this.titleOffset !== b;
                this.titleOffset = b;
                !this.isDirtyBox && e && (this.isDirtyBox = this.isDirtyLegend = e, this.hasRendered && E(a, !0) && this.isDirtyBox && this.redraw())
            },
            getChartSize: function() {
                var b = this.options.chart,
                    ...
                    k = this.renderTo;
                d(e) ||
                    (this.containerWidth = a.getStyle(k, "width"));
                d(b) || (this.containerHeight = a.getStyle(k, "height"));
            ...
            temporaryDisplay: function(b) {
                var e = this.renderTo;
                if (b)
                    for (; e && e.style;) e.hcOrigStyle && (a.css(e, e.hcOrigStyle), delete e.hcOrigStyle), e.hcOrigDetached && (c.body.removeChild(e), e.hcOrigDetached = !1), e = e.parentNode;
                else
                    for (; e && e.style;) {
                        c.body.contains(e) ||
                            e.parentNode || (e.hcOrigDetached = !0, c.body.appendChild(e));
            ...
            getContainer: function() {
                ...
                v(e) && (this.renderTo = e = c.getElementById(e));
                e || a.error(13, !0, this);
                f = C(h(e, "data-highcharts-chart"));
                ...
                this.renderer = new(a[k.renderer] || a.Renderer)(e, f, q, null, k.forExport, d.exporting && d.exporting.allowHTML, this.styledMode);
                this.setClassName(k.className);
                if (this.styledMode)
                    for (t in d.defs) this.renderer.definition(d.defs[t]);
            ...
            getMargins: function(a) {
                var e = this.spacing,
                    ...
                    f = this.titleOffset;
                this.resetMargins();
                f && !d(k[0]) && (this.plotTop = Math.max(this.plotTop, f + this.options.title.margin + e[0]));
                this.legend && this.legend.display && this.legend.adjustMargins(k, e);
                b(this, "getMargins");
            ...
            setReflow: function(a) {
                ...
                !1 === a || this.unbindReflow ? !1 === a && this.unbindReflow && (this.unbindReflow =
                    this.unbindReflow()) : (this.unbindReflow = z(K, "resize", function(a) {
                    b.reflow(a)
            ...
            setSize: function(e, k, d) {
                ...
                void 0 !== e && (f.options.chart.width = e);
                void 0 !== k && (f.options.chart.height = k);
                f.getChartSize();
                f.styledMode || (q = c.globalAnimation, (q ? F : g)(f.container, {
                    width: f.chartWidth + "px",
                    height: f.chartHeight + "px"
                }, q));
                f.setChartSize(!0);
                c.setSize(f.chartWidth,
                    f.chartHeight, d);
                f.axes.forEach(function(a) {
                    a.isDirty = !0;
                    a.setScale()
            ...
            setChartSize: function(a) {
                ...
                this.plotWidth = n = Math.max(0, Math.round(d - l - this.marginRight));
                this.plotHeight = h = Math.max(0, Math.round(f - m - this.marginBottom));
                this.plotSizeX = e ? h : n;
                this.plotSizeY = e ? n : h;
                ...
                k = Math.ceil(Math.max(d, q[0]) / 2);
                this.clipBox = {
                    x: e,
                    y: k,
                    width: Math.floor(this.plotSizeX - Math.max(d,
                        q[1]) / 2 - e),
                    height: Math.max(0, Math.floor(this.plotSizeY - Math.max(d, q[2]) / 2 - k))
                };
            ...
            resetMargins: function() {
                ...
                ["margin", "spacing"].forEach(function(b) {
                    var k = e[b],
                        d = f(k) ? k : [k, k, k, k];
                    ["Top", "Right", "Bottom", "Left"].forEach(function(k, f) {
                        a[b][f] = E(e[b + k], d[f])
                    })
                });
            ...
            drawChartBox: function() {
                ...
                if (l) q = C = f.strokeWidth();
                    ...
                    if (q || f["stroke-width"]) n.stroke = a.borderColor, n["stroke-width"] = q;
                    f.attr(n).shadow(a.shadow)
                }
                f[w]({
                    x: C / 2,
                    y: C / 2,
                ...
                w = "animate";
                c || (w = "attr", this.plotBackground = c = e.rect().addClass("highcharts-plot-background").add());
                c[w](r);
                l || (c.attr({
                    fill: h || "none"
                }).shadow(a.plotShadow), E && (m ? m.animate(r) : this.plotBGImage = e.image(E, t, p, y, v).add()));
                A ? A.animate({
                    width: u.width,
                    height: u.height
                }) : this.clipRect = e.clipRect(u);
                w = "animate";
                g || (w = "attr", this.plotBorder = g = e.rect().addClass("highcharts-plot-border").attr({
                    zIndex: 1
                }).add());
                l || g.attr({
            ...
            propFromSeries: function() {
                var a = this,
                    b = a.options.chart,
                    k, d = a.options.series,
                    f, c;
                ["inverted", "angular", "polar"].forEach(function(g) {
                    k = e[b.type || b.defaultSeriesType];
                    c = b[g] || k && k.prototype[g];
                    for (f = d && d.length; !c && f--;)(k = e[d[f].type]) && k.prototype[g] && (c = !0);
                    a[g] = c
                })
            },
            linkSeries: function() {
                ...
                e.forEach(function(b) {
                    ...
                    v(e) && (e = ":previous" === e ? a.series[b.index - 1] : a.get(e)) && e.linkedParent !== b && (e.linkedSeries.push(b), b.linkedParent = e, b.visible = E(b.options.visible, e.options.visible, b.visible))
                });
            ...
            renderLabels: function() {
                ...
                b.items && b.items.forEach(function(e) {
                    var k = m(b.style, e.style),
                        ...
                        f = C(k.top) + a.plotTop + 12;
                    delete k.left;
                    delete k.top;
                    a.renderer.text(e.html, d, f).attr({
                        zIndex: 2
                    }).css(k).add()
                })
            },
            render: function() {
                ...
                d = this.plotHeight = Math.max(this.plotHeight - k, 0);
                a.forEach(function(a) {
                    a.setScale()
                });
                this.getAxisMargins();
                f = 1.1 < e / this.plotWidth;
                c = 1.05 < d / this.plotHeight;
                if (f || c) a.forEach(function(a) {
            ...
            destroy: function() {
                var e = this,
                    ...
                    c, g = f && f.parentNode;
                b(e, "destroy");
                e.renderer.forExport ? a.erase(p, e) : p[e.index] = void 0;
                a.chartCount--;
                e.renderTo.removeAttribute("data-highcharts-chart");
                y(e);
                for (c = k.length; c--;) k[c] = k[c].destroy();
    ...
    (function(a) {
        var z = a.addEvent,
            F = a.Chart;
        z(F, "afterSetChartSize", function(z) {
            var h = this.options.chart.scrollablePlotArea;
            (h = h && h.minWidth) && !this.renderer.forExport && (this.scrollablePixels = h = Math.max(0, h - this.chartWidth)) && (this.plotWidth += h, this.clipBox.width += h, z.skipAxes || this.axes.forEach(function(c) {
    ...
    (function(a) {
        ...
        a.Point.prototype = {
            ...
            applyOptions: function(a, c) {
                ...
                b && (this.y = this[b]);
                this.isNull = w(this.isValid && !this.isValid(), null === this.x || !u(this.y, !0));
            ...
            optionsToObject: function(d) {
                var c = {},
                    ...
                    h = 0,
                    t = 0;
                if (u(d) || null === d) c[l[0]] = d;
                else if (r(d))
                    for (!b && d.length > f && (g = typeof d[0], "string" === g ? c.name = d[0] : "number" === g && (c.x = d[0]), h++); t < f;) b && void 0 === d[h] || (0 < l[t].indexOf(".") ? a.Point.prototype.setNestedProperty(c,
                        d[h], l[t]) : c[l[t]] = d[h]), h++, t++;
                else "object" === typeof d && (c = d, d.dataLabels && (g._hasPointLabels = !0), d.marker && (g._hasPointMarkers = !0));
                return c
            },
        ...
        a.Series = a.seriesType("line", null, {
            ...
            updateParallelArrays: function(a, b) {
                var k = a.series,
                    d = arguments,
                    e = m(b) ? function(e) {
                        var d = "y" === e && k.toYData ? k.toYData(a) : a[e];
                        k[e + "Data"][b] = d
                    } : function(a) {
            ...
            setOptions: function(a) {
                var d = this.chart,
                    ...
                    q = c[this.type],
                    l = d.styledMode;
                this.userOptions = b(a);
                d = b(q, c.series, a);
                this.tooltipOptions = b(r.tooltip, r.plotOptions.series && r.plotOptions.series.tooltip, r.plotOptions[this.type].tooltip, k.tooltip.userOptions, c.series && c.series.tooltip, c[this.type].tooltip, a.tooltip);
                ...
                !d.negativeColor && !d.negativeFillColor || d.zones || (k = {
                    value: d[this.zoneAxis + "Threshold"] || d.threshold || 0,
                    className: "highcharts-negative"
                }, l || (k.color = d.negativeColor, k.fillColor = d.negativeFillColor), a.push(k));
                a.length && w(a[a.length - 1].value) && a.push(l ? {} : {
                    color: this.color,
            ...
            getCyclic: function(a,
                ...
                b || (k = f(c[g], c["_" + g]), w(k) || (e.series.length || (e[l] = 0), c["_" + g] = k = e[l] % m, e[l] += 1), d && (b = d[k]));
                void 0 !== k && (this[g] = k);
                this[a] = b
            },
            getColor: function() {
            ...
            updateData: function(b) {
                ...
                b.forEach(function(b) {
                    ...
                    h = c.x;
                    if ((c = c.id) || m(h)) c && (q = (q = this.chart.get(c)) && q.index), void 0 === q && m(h) && (q = this.xData.indexOf(h, g)), -1 === q || void 0 === q || k[q].touched ? f.push(b) : b !== d.data[q] ? (k[q].update(b,
                        !1, null, !1), k[q].touched = !0, l && (g = q + 1)) : k[q] && (k[q].touched = !0), e = !0
                }, this);
                if (e)
                    for (b = k.length; b--;) c = k[b], c.touched || c.remove(!1), c.touched = !1;
            ...
            setData: function(b, c, g, l) {
                ...
                t = b.length;
                c = f(c, !0);
                !1 !== l && t && h && !e.cropped && !e.hasGroupedData && e.visible && !e.isSeriesBoosting && (H = this.updateData(b));
                if (!H) {
                    e.xIncrement = null;
                    e.colorCounter = 0;
                    ...
                    if (y && t > y) {
                        for (g = 0; null === v && g < t;) v = b[g], g++;
                        if (m(v))
                            for (g = 0; g < t; g++) r[g] = this.autoIncrement(), A[g] = b[g];
                        else if (d(v))
                            if (u)
                                for (g = 0; g < t; g++) v = b[g], r[g] = v[0], A[g] = v.slice(1, u + 1);
                            else
                                for (w && (D = w.indexOf("x"), x = w.indexOf("y"), D = 0 <= D ? D : 0, x = 0 <= x ? x : 1), g =
                                    0; g < t; g++) v = b[g], r[g] = v[D], A[g] = v[x];
                        else a.error(12, !1, p)
                    } else
                        for (g = 0; g < t; g++) void 0 !== b[g] && (v = {
                            series: e
                        }, e.pointClass.prototype.applyOptions.apply(v, [b[g]]), e.updateParallelArrays(v, g));
                    A && n(A[0]) && a.error(14, !0, p);
                    e.data = [];
                    e.options.data = e.userOptions.data = b;
                    for (g = h; g--;) k[g] && k[g].destroy && k[g].destroy();
                    C && (C.minRange = C.userMinRange);
                    e.isDirty = p.isDirtyBox = !0;
                    e.isDirtyData = !!k;
                    g = !1
                }
            ...
            processData: function(b) {
                ...
                l && (b = l.getExtremes(), r = b.min, A = b.max);
                t && this.sorted && !n && (!m || f > m || this.forceCrop) && (d[f - 1] < r || d[0] > A ? (d = [], k = []) : this.yData && (d[0] < r || d[f - 1] > A) && (e = this.cropData(this.xData, this.yData, r, A), d = e.xData, k = e.yData, e =
                    e.start, c = !0));
                for (m = d.length || 1; --m;) f = p ? h(d[m]) - h(d[m - 1]) : d[m] - d[m - 1], 0 < f && (void 0 === g || f < g) ? g = f : 0 > f && v && (a.error(15, !1, this.chart), v = !1);
                this.cropped = c;
                this.cropStart = e;
            ...
            generatePoints: function() {
                var a =
                    ...
                    m = e.length,
                    h = this.cropStart || 0,
                    n, v = this.hasGroupedData,
                    a = a.keys,
                    r, A = [],
                    u;
                d || v || (d = [], d.length = b.length, d = this.data = d);
                a && v && (this.options.keys = !1);
                for (u = 0; u < m; u++) n = h + u, v ? (r = (new l).init(this, [e[u]].concat(t(c[u]))), r.dataGroup = this.groupMap[u], r.dataGroup.options && (r.options = r.dataGroup.options, p(r, r.dataGroup.options), delete r.dataLabels)) : (r = d[n]) || void 0 === b[n] || (d[n] = r = (new l).init(this, b[n], e[u])),
                    r && (r.index = n, A[u] = r);
                this.options.keys = a;
                if (d && (m !== (f = d.length) || v))
                    for (u = 0; u < f; u++) u !== h || v || (u += m), d[u] && (d[u].destroyElements(), d[u].plotX = void 0);
                this.data = d;
                this.points = A;
            ...
            getExtremes: function(a) {
                ...
                var l = f.min,
                    n = f.max,
                    t, p, v = this.requireSorting ? 1 : 0,
                    r, A;
                a = a || this.stackedYData || this.processedYData || [];
                f = a.length;
                for (A = 0; A < f; A++)
                    if (p = k[A], r = a[A], t = (m(r, !0) || d(r)) && (!b.positiveValuesOnly || r.length ||
                            0 < r), p = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (k[A + v] || p) >= l && (k[A - v] || p) <= n, t && p)
                        if (t = r.length)
                            for (; t--;) "number" === typeof r[t] && (e[c++] = r[t]);
                        else e[c++] = r;
                this.dataMin = h(e);
                this.dataMax = G(e);
            ...
            translate: function() {
                ...
                var a = this.options,
                    ...
                    h = q.length,
                    n = !!this.modifyValue,
                    t, p = this.pointPlacementToXValue(),
                    v = m(p),
                    r = a.threshold,
                    A = a.startFromThreshold ? r : 0,
                    u, D, x, H, z = this.zoneAxis || "y",
                    G = Number.MAX_VALUE;
                for (t = 0; t < h; t++) {
                    var F = q[t],
                        I = F.x,
                        Q = F.y;
                    D = F.low;
                    var M = b && e.stacks[(this.negStacks && Q < (A ? 0 : r) ? "-" : "") + this.stackKey],
                        V;
                    e.positiveValuesOnly && null !== Q && 0 >= Q && (F.isNull = !0);
                    F.plotX = u = c(Math.min(Math.max(-1E5, d.translate(I, 0, 0, 0, 1, p, "flags" === this.type)), 1E5));
                    b && this.visible && !F.isNull && M && M[I] && (H = this.getStackIndicator(H, I, this.index), V = M[I], Q = V.points[H.key], D = Q[0], Q = Q[1], D === A && H.key === M[I].base && (D = f(m(r) && r, e.min)), e.positiveValuesOnly &&
                        0 >= D && (D = null), F.total = F.stackTotal = V.total, F.percentage = V.total && F.y / V.total * 100, F.stackY = Q, V.setOffset(this.pointXOffset || 0, this.barW || 0));
                    F.yBottom = w(D) ? Math.min(Math.max(-1E5, e.translate(D, 0, 1, 0, 1)), 1E5) : null;
                    n && (Q = this.modifyValue(Q, F));
                    F.plotY = D = "number" === typeof Q && Infinity !== Q ? Math.min(Math.max(-1E5, e.translate(Q, 0, 1, 0, 1)), 1E5) : void 0;
                    F.isInside = void 0 !== D && 0 <= D && D <= e.len && 0 <= u && u <= d.len;
                    F.clientX = v ? c(d.translate(I, 0, 0, 0, 1, p)) : u;
                    F.negative = F[z] < (a[z + "Threshold"] || r || 0);
                    F.category = l && void 0 !==
                        l[F.x] ? l[F.x] : F.x;
                    F.isNull || (void 0 !== x && (G = Math.min(G, Math.abs(u - x))), x = u);
            ...
            setClip: function(a) {
                var b = this.chart,
                    ...
                    k = this.clipBox,
                    c = k || b.clipBox,
                    g = this.sharedClipKey || ["_sharedClip", a && a.duration, a && a.easing, c.height,
                        d.xAxis, d.yAxis
                    ].join(),
                    l = b[g],
                    m = b[g + "m"];
                l || (a && (c.width = 0, e && (c.x = b.plotSizeX), b[g + "m"] = m = f.clipRect(e ? b.plotSizeX + 99 : -99, e ? -b.plotLeft : -b.plotTop, 99, e ? b.chartWidth : b.chartHeight)), b[g] = l = f.clipRect(c), l.count = {
                    length: 0
                });
                a && !l.count[this.index] && (l.count[this.index] = !0, l.count.length += 1);
                !1 !== d.clip && (this.group.clip(a || k ? l : b.clipRect), this.markerGroup.clip(m), this.sharedClipKey = g);
                a || (l.count[this.index] && (delete l.count[this.index], --l.count.length), 0 === l.count.length && g && b[g] && (k || (b[g] = b[g].destroy()),
            ...
            getGraphPath: function(a,
                ...
                a.forEach(function(k, q) {
                    var h = k.plotX,
                        n = k.plotY,
                        t = a[q - 1];
                    (k.leftCliff || t && t.rightCliff) && !d && (m = !0);
                    k.isNull && !w(b) && 0 < q ? m = !e.connectNulls : k.isNull && !b ? m = !0 : (0 === q || m ? q = ["M", k.plotX, k.plotY] : f.getPointSpline ? q = f.getPointSpline(a, k, q) : c ? (q = 1 === c ? ["L", t.plotX, n] : 2 === c ? ["L", (t.plotX + h) / 2, t.plotY, "L", (t.plotX + h) / 2, n] : ["L", h, t.plotY], q.push("L", h, n)) : q = ["L", h, n], l.push(k.x), c && (l.push(k.x), 2 === c && l.push(k.x)), g.push.apply(g, q), m = !1)
                });
                g.xMap = l;
                return f.graphPath = g
            },
            drawGraph: function() {
                var a = this,
                    b = this.options,
                ...
                e.forEach(function(e, c) {
                    ...
                    g ? (g.endX = a.preventGraphAnimation ? null : d.xMap, g.animate({
                        d: d
                    })) : d.length && (a[k] = a.chart.renderer.path(d).addClass(e[1]).attr({
                            zIndex: 1
                        }).add(a.group),
                        f || (g = {
                            stroke: e[2],
                        ...
                        }, e[3] ? g.dashstyle = e[3] : "square" !== b.linecap && (g["stroke-linecap"] = g["stroke-linejoin"] = "round"), g = a[k].attr(g).shadow(2 > c && b.shadow)));
            ...
            applyZones: function() {
                var a = this,
                    ...
                    v, r, A = b.inverted,
                    u, w, D, x, H = !1;
                c.length && (h || n) && p && void 0 !== p.min && (r = p.reversed, u = p.horiz, h && !this.showLine && h.hide(), n && n.hide(), v = p.getExtremes(), c.forEach(function(c, k) {
                    e = r ? u ? b.plotWidth : 0 : u ? 0 : p.toPixels(v.min) || 0;
                    e = Math.min(Math.max(f(g, e), 0), t);
                    g = Math.min(Math.max(Math.round(p.toPixels(f(c.value,
                        v.max), !0) || 0), 0), t);
                    H && (e = g = p.toPixels(v.max));
                    w = Math.abs(e - g);
                    D = Math.min(e, g);
                    x = Math.max(e, g);
                    p.isXAxis ? (m = {
                    ...
                    l[k] ? l[k].animate(m) : (l[k] = d.clipRect(m), h && a["zone-graph-" + k].clip(l[k]), n && a["zone-area-" + k].clip(l[k]));
                    H = c.value > v.max;
                    a.resetZones &&
                        0 === g && (g = void 0)
                }), this.clips = l)
            ...
            invertGroups: function(a) {
                ...
                var d = this,
                    c = d.chart,
                    e;
                d.xAxis && (e = z(c, "resize", b), z(d, "destroy", e), b(a), d.invertGroups = b)
            },
            plotGroup: function(a, b, d, c, e) {
                ...
                f.addClass("highcharts-" + b + " highcharts-series-" +
                    this.index + " highcharts-" + this.type + "-series " + (w(this.colorIndex) ? "highcharts-color-" + this.colorIndex + " " : "") + (this.options.className || "") + (f.hasClass("highcharts-tracker") ? " highcharts-tracker" : ""), !0);
                f.attr({
                    visibility: d
            ...
            render: function() {
                var a = this,
                    ...
                    n = b.inverted;
                g(this, "render");
                d = a.plotGroup("group", "series", f, l, h);
                a.markerGroup = a.plotGroup("markerGroup", "markers", f, l, h);
                e && a.animate(!0);
                ...
                e && a.animate();
                m || (a.animationTimeout = D(function() {
                    a.afterAnimate()
                }, e));
                a.isDirty = !1;
                a.hasRendered = !0;
            ...
            buildKDTree: function(a) {
                function b(a, c, f) {
                    var e, k;
                    if (k = a && a.length) return e = d.kdAxisArray[c % f], a.sort(function(a, b) {
                        return a[e] - b[e]
                    }), k = Math.floor(k / 2), {
                        point: a[k],
                        left: b(a.slice(0, k), c + 1, f),
                        right: b(a.slice(k + 1), c + 1, f)
                    }
                }
            ...
            searchKDTree: function(a, b, d) {
                function c(a, b, d, l) {
                    var m = b.point,
                        h = e.kdAxisArray[d % l],
                        q, n, t = m;
                    n = w(a[f]) && w(m[f]) ? Math.pow(a[f] - m[f], 2) : null;
                    q = w(a[k]) && w(m[k]) ? Math.pow(a[k] - m[k], 2) : null;
                    q = (n || 0) + (q || 0);
                    m.dist = w(q) ? Math.sqrt(q) : Number.MAX_VALUE;
                    m.distX = w(n) ? Math.sqrt(n) : Number.MAX_VALUE;
                    h = a[h] - m[h];
                    q = 0 > h ? "left" : "right";
                    n = 0 > h ? "right" : "left";
                    b[q] &&
                        (q = c(a, b[q], d + 1, l), t = q[g] < t[g] ? q : m);
                    b[n] && Math.sqrt(h * h) < t[g] && (a = c(a, b[n], d + 1, l), t = a[g] < t[g] ? a : t);
                    return t
                }
                var e = this,
            ...
            pointPlacementToXValue: function() {
                ...
                "between" === a && (a = .5);
                m(a) && (a *= f(this.options.pointRange || this.xAxis.pointRange));
                return a
            }
        })
    })(I);
    (function(a) {
        ...
        a.StackItem.prototype = {
            ...
            setOffset: function(a, c) {
                var d = this.axis,
                    g = d.chart,
                    n = d.translate(d.usePercentage ?
                        100 : this.total, 0, 0, 0, 1),
                    b = d.translate(0),
                    b = h(n) && Math.abs(n - b);
                a = g.xAxis[0].translate(this.x) + a;
                d = h(n) && this.getStackBox(g, this, a, n, c, b, d);
        ...
        z.prototype.cleanStacks = function() {
            ...
            this.isXAxis || (this.oldStacks &&
                (a = this.stacks = this.oldStacks), u(a, function(a) {
                    u(a, function(a) {
            ...
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                ...
                for (q = 0; q < m; q++) x =
                    c[q], z = g[q], E = this.getStackIndicator(E, x, this.index), e = E.key, y = (C = r && z < (l ? 0 : b)) ? t : v, A[y] || (A[y] = {}), A[y][x] || (k[y] && k[y][x] ? (A[y][x] = k[y][x], A[y][x].total = null) : A[y][x] = new a.StackItem(u, u.options.stackLabels, C, x, f)), y = A[y][x], null !== z ? (y.points[e] = y.points[this.index] = [w(y.cumulative, l)], h(y.cumulative) || (y.base = e), y.touched = u.stacksTouched, 0 < E.index && !1 === this.singleStacks && (y.points[e][0] = y.points[this.index + "," + x + ",0"][0])) : y.points[e] = y.points[this.index] = null, "percent" === n ? (C = C ? v : t, r && A[C] &&
                        A[C][x] ? (C = A[C][x], y.total = C.total = Math.max(C.total, y.total) + Math.abs(z) || 0) : y.total = G(y.total + (Math.abs(z) || 0))) : y.total = G(y.total + (z || 0)), y.cumulative = w(y.cumulative, l) + (z || 0), null !== z && (y.points[e].push(y.cumulative), d[q] = y.cumulative);
                "percent" === n && (u.usePercentage = !0);
                this.stackedYData = d;
                u.oldStacks = {}
            }
        };
    ...
    (function(a) {
        ...
        a.cleanRecursively = function(c, f) {
            var k = {};
            b(c, function(b, g) {
                if (d(c[g], !0) && f[g]) b = a.cleanRecursively(c[g], f[g]), Object.keys(b).length && (k[g] = b);
                else if (d(c[g]) || c[g] !== f[g]) k[g] = c[g]
            });
            return k
        };
        x(h.prototype, {
            ...
            update: function(d, c, f, m) {
                ...
                d.isResponsiveOptions || k.setResponsive(!1, !0);
                d = a.cleanRecursively(d, k.options);
                if (h = d.chart) {
                    n(!0, k.options.chart, h);
                ...
                d.plotOptions && n(!0, this.options.plotOptions, d.plotOptions);
                b(d, function(a, b) {
                    if (k[b] && "function" === typeof k[b].update) k[b].update(a, !1);
                    else if ("function" === typeof k[e[b]]) k[e[b]](a);
                    "chart" !== b && -1 !== k.propsRequireUpdateSeries.indexOf(b) && (v = !0)
                });
                this.collectionsWithUpdate.forEach(function(a) {
                    var b;
                    d[a] && ("series" === a && (b = [], k[a].forEach(function(a, e) {
                        a.options.isInternal || b.push(l(a.options.index, e))
                    })), D(d[a]).forEach(function(e, d) {
                        (d = u(e.id) && k.get(e.id) || k[a][b ? b[d] : d]) && d.coll === a && (d.update(e, !1), f && (d.touched = !0));
                        if (!d && f)
                            if ("series" === a) k.addSeries(e, !1).touched = !0;
                            else if ("xAxis" === a || "yAxis" === a) k.addAxis(e, "xAxis" === a, !1).touched = !0
                ...
                d.loading && n(!0, k.options.loading, d.loading);
                t = h && h.width;
                h = h && h.height;
        ...
        x(f.prototype, {
            update: function(a, b, c, f) {
                function k() {
                    e.applyOptions(a);
                    null === e.y && m && (e.graphic = m.destroy());
                    d(a, !0) && (m && m.element && a && a.marker &&
                        void 0 !== a.marker.symbol && (e.graphic = m.destroy()), a && a.dataLabels && e.dataLabel && (e.dataLabel = e.dataLabel.destroy()), e.connector && (e.connector = e.connector.destroy()));
                    h = e.index;
                    g.updateParallelArrays(e, h);
                    t.data[h] = d(t.data[h], !0) || d(a, !0) ? e.options : l(a, t.data[h]);
        ...
        x(v.prototype, {
            addPoint: function(a, b, d, c) {
                ...
                p = h.x;
                v = t.length;
                if (this.requireSorting && p < t[v - 1])
                    for (n = !0; v && t[v - 1] > p;) v--;
                this.updateParallelArrays(h, "splice", v, 0, 0);
                this.updateParallelArrays(h, v);
                g && h.name && (g[p] = h.name);
                m.splice(v, 0, a);
                n && (this.data.splice(v, 0, null), this.processData());
                "point" === f.legendType && this.generatePoints();
                d && (e[0] && e[0].remove ? e[0].remove(!1) : (e.shift(), this.updateParallelArrays(h, "shift"), m.shift()));
            ...
            update: function(b, d) {
                ...
                var c = this,
                    ...
                    m = t[e].prototype,
                    h, v = ["group", "markerGroup", "dataLabelsGroup"],
                ...
                if (D) b.data && this.setData(b.data, !1), b.name && this.setName(b.name, !1);
                else {
                    r = v.concat(r);
                    r.forEach(function(a) {
                        r[a] = c[a];
                    ...
                    b = n(k, u, {
                        index: c.index,
                        pointStart: l(k.pointStart, c.xData[0])
                    }, {
                        data: c.options.data
                    }, b);
                    c.remove(!1, null, !1);
                    for (h in m) c[h] = void 0;
                    t[g || e] ? x(c, t[g || e].prototype) : a.error(17, !0, f);
                    r.forEach(function(a) {
                        c[a] = r[a]
                    });
                    c.init(f, b);
                    b.zIndex !== k.zIndex && v.forEach(function(a) {
                        c[a] && c[a].attr({
                            zIndex: b.zIndex
                        })
                    });
        ...
        h("area", "line", {
            ...
            getStackPoints: function(c) {
                var h = [],
                    ...
                    m = x.series,
                    n = m.length,
                    b, l = F(x.options.reversedStacks, !0) ? 1 : -1,
                    f;
                c = c || this.points;
                    ...
                    u.forEach(function(a, c) {
                        ...
                        if (g[a] && !g[a].isNull) h.push(g[a]), [-1, 1].forEach(function(k) {
                            var m = 1 === k ? "rightNull" : "leftNull",
                                ...
                                r = p[u[c + k]];
                            if (r)
                                for (f = d; 0 <= f && f < n;) t = r.points[f], t || (f === d ? g[a][m] = !0 : b[f] && (v = p[a].points[f]) && (h -= v[1] - v[0])), f += l;
            ...
            getGraphPath: function(a) {
                var c = G.prototype.getGraphPath,
                    ...
                    m = [],
                    n = this.index,
                    b, l = x.stacks[this.stackKey],
                    f = h.threshold,
                    v = x.getThreshold(h.threshold),
                    t, h = h.connectNulls || "percent" === w,
                    H = function(c, g, k) {
                        var h = a[c];
                        c = w && l[h.x].points[n];
                        var t = h[k + "Null"] || 0;
                        k = h[k + "Cliff"] || 0;
                        var p, e, h = !0;
                        k || t ? (p = (t ? c[0] : c[1]) + k, e = c[0] + k, h = !!t) : !w && a[g] && a[g].isNull &&
                            (p = e = f);
                        void 0 !== p && (m.push({
                            plotX: b,
                            plotY: null === p ? v : x.getThreshold(p),
                            isNull: h,
                            isCliff: !0
                        }), d.push({
                            plotX: b,
                            plotY: null === e ? v : x.getThreshold(e),
                            doCurve: !1
                        }))
                    };
                a = a || this.points;
                ...
                for (p = 0; p < a.length; p++)
                    if (g = a[p].isNull, b = F(a[p].rectPlotX, a[p].plotX), t = F(a[p].yBottom, v), !g || h) h || H(p, p - 1, "left"), g && !w && h || (m.push(a[p]), d.push({
                        x: p,
                        plotX: b,
                        plotY: t
                    })), h || H(p, p + 1, "right");
            ...
            drawGraph: function() {
                ...
                w.forEach(function(c) {
                    ...
                    g ? (g.endX = a.preventGraphAnimation ? null : h.xMap, g.animate({
                        ...
                        (g.fill = F(c[3], z(c[2]).setOpacity(F(u.fillOpacity, .75)).get())), g = a[p] = a.chart.renderer.path(h).addClass(c[1]).attr(g).add(a.group), g.isArea = !0);
                    g.startX = h.xMap;
    ...
    (function(a) {
        ...
        a("spline", "line", {}, {
            getPointSpline: function(a, G, h) {
                ...
                h = a[h + 1];
                var w, x, p, g;
                if (u && !u.isNull && !1 !== u.doCurve && !G.isCliff && h && !h.isNull && !1 !== h.doCurve && !G.isCliff) {
                    a = u.plotY;
                    p = h.plotX;
                    h =
                        h.plotY;
                    ...
                    p = (1.5 * c + p) / 2.5;
                    g = (1.5 * r + h) / 2.5;
                    p !== w && (d = (g - x) * (p - c) / (p - w) + r - g);
                    x += d;
                    g += d;
                    x > a && x > r ? (x = Math.max(a, r), g = 2 * r - x) : x < a && x < r && (x = Math.min(a, r), g = 2 * r - x);
                    g > h && g > r ? (g = Math.max(h, r), x = 2 * r - g) : g < h && g < r && (g = Math.min(h, r), x = 2 * r - g);
                    G.rightContX = p;
                    G.rightContY = g
                }
                G = ["C", z(u.rightContX, u.plotX), z(u.rightContY, u.plotY), z(w, c), z(x, r), c, r];
        ...
        x("column", "line", {
            ...
            getColumnMetrics: function() {
                var a = this,
                    ...
                    h = a.yAxis,
                    b =
                    c.options.reversedStacks,
                    b = c.reversed && !b || !c.reversed && b,
                    l, f = {},
                    v = 0;
                !1 === d.grouping ? v = 1 : a.chart.series.forEach(function(b) {
                    var d = b.options,
                        c = b.yAxis,
                        g;
                    b.type !== a.type || !b.visible && a.chart.options.chart.ignoreHiddenSeries || h.len !== c.len || h.pos !== c.pos || (d.stacking ? (l = b.stackKey, void 0 === f[l] && (f[l] = v++), g = f[l]) : !1 !== d.grouping && (g = v++), b.columnIndex = g)
                });
                var t = Math.min(Math.abs(c.transA) * (c.ordinalSlope || d.pointRange || c.closestPointRange || c.tickInterval || 1), c.len),
                    p = t * d.groupPadding,
                    r = (t - 2 * p) / (v ||
                        1),
                    d = Math.min(d.maxPointWidth || c.len, u(d.pointWidth, r * (1 - 2 * d.pointPadding)));
                a.columnMetrics = {
                    width: d,
                    offset: (r - d) / 2 + (p + ((a.columnIndex || 0) + (b ? 1 : 0)) * r - t / 2) * (b ? -1 : 1)
                };
            ...
            translate: function() {
                ...
                a.points.forEach(function(c) {
                    var g = u(c.yBottom, f),
                        ...
                        t = Math.min(k, g),
                        w, D = Math.max(k, g) - t;
                    v && Math.abs(D) < v && (D = v, w = !b.reversed && !c.negative || b.reversed && c.negative, c.y === l && a.dataMax <= l && b.min < l && (w = !w), t = Math.abs(t - f) > v ? g - v : f - (w ? v : 0));
                    h(c.options.pointWidth) && (m = n = Math.ceil(c.options.pointWidth), e -= Math.round((m - p) / 2));
                    c.barX = e;
                    c.pointWidth = m;
                    c.tooltipPos = d.inverted ? [b.len + b.pos - d.plotLeft - k, a.xAxis.len - e - n / 2, D] : [e + n / 2, k + b.pos - d.plotTop, D];
                    c.shapeType = c.shapeType || "rect";
                    c.shapeArgs = a.crispCol.apply(a, c.isNull ? [e, f, n, 0] : [e, t, n, D])
                })
            },
            getSymbol: a.noop,
            drawLegendSymbol: a.LegendSymbolMixin.drawRectangle,
            ...
            pointAttribs: function(a, d) {
                ...
                var h = b["stroke-width"] || "borderWidth",
                ...
                d && (a = r(c.states[d], a.options.states &&
                    a.options.states[d] || {}), d = a.brightness, f = a.color || void 0 !== d && F(f).brighten(a.brightness).get() || f, v = a[g] || v, t = a[h] || t, b = a.dashStyle || b);
                g = {
                    fill: f,
                    stroke: v,
                    "stroke-width": t
            ...
            drawPoints: function() {
                ...
                a.points.forEach(function(f) {
                    ...
                    if (c(f.plotY) && null !== f.y) {
                        l = f.shapeArgs;
                        if (g) g[m](r(l));
                        else f.graphic = g = n[f.shapeType](l).add(f.group || a.group);
                        h.borderRadius &&
                            g.attr({
                                r: h.borderRadius
                            });
            ...
            animate: function(a) {
                var d = this,
                    ...
                    v;
                p && (a ? (h.scaleY = .001, a = Math.min(c.pos + c.len, Math.max(c.pos, c.toPixels(g.threshold))), b ? h.translateX = a - c.len : h.translateY = a, d.clipBox && d.setClip(), d.group.attr(h)) : (v = d.group.attr(f), d.group.animate({
                        scaleY: 1
                    },
    ...
    (function(a) {
        ...
        F("scatter", "line", {
            ...
            applyJitter: function() {
                ...
                h && this.points.forEach(function(r, u) {
                    ["x", "y"].forEach(function(w, x) {
                        var p, g = "plot" + w.toUpperCase(),
                            d, m;
                        h[w] && !r.isNull &&
        ...
        a.CenteredSeriesMixin = {
            getCenter: function() {
                var a = this.options,
                    ...
                    x = a.center,
                    x = [G(x[0], "50%"),
                        G(x[1], "50%"), a.size || "100%", a.innerSize || 0
                    ],
                    p = Math.min(w, r),
                    g, d;
                for (g = 0; 4 > g; ++g) d = x[g], a = 2 > g || 2 === g && /%$/.test(d), x[g] = h(d, [w, r, p, x[2]][g]) + (a ? u : 0);
                x[3] > x[2] && (x[3] = x[2]);
                return x
            },
        ...
        p("pie", "line", {
            ...
            updateTotals: function() {
                var a, c = 0,
                    g = this.points,
                    b = g.length,
                    h, f = this.options.ignoreHiddenPoint;
                for (a = 0; a < b; a++) h = g[a], c += f && !h.visible ? 0 :
                    h.isNull ? 0 : h.y;
                this.total = c;
            ...
            translate: function(a) {
                ...
                var d =
                    ...
                    b = g.slicedOffset,
                    h = b + (g.borderWidth || 0),
                    f, p, t = c(g.startAngle, g.endAngle),
                    r = this.startAngleRad = t.start,
                    t = (this.endAngleRad = t.end) - r,
                    w = this.points,
                    A, k, x = g.dataLabels.distance,
                ...
                for (C = 0; C < y; C++) {
                    e = w[C];
                    e.labelDistance = u(e.options.dataLabels && e.options.dataLabels.distance, x);
                    ...
                    A = Math.cos(p) * a[2] / 2;
                    k = Math.sin(p) * a[2] / 2;
                    e.tooltipPos = [a[0] + .7 * A, a[1] + .7 * k];
                    e.half = p < -Math.PI / 2 || p > Math.PI / 2 ? 1 : 0;
                    e.angle = p;
                    f = Math.min(h, e.labelDistance / 5);
                    e.labelPosition = {
                        natural: {
                            x: a[0] + A + Math.cos(p) * e.labelDistance,
                            y: a[1] + k + Math.sin(p) *
                                e.labelDistance
                        },
                        "final": {},
                        ...
                        connectorPosition: {
                            breakAt: {
                                x: a[0] + A + Math.cos(p) * f,
                                y: a[1] + k + Math.sin(p) * f
                            },
                            touchingSliceAt: {
                                x: a[0] + A,
                                y: a[1] + k
            ...
            drawPoints: function() {
                ...
                a.points.forEach(function(d) {
                    ...
                    if (d.isNull) l && (d.graphic = l.destroy());
                        ...
                        l ? (l.setRadialReference(a.center), c.styledMode || l.attr(f), l.animate(h(p, b))) : (d.graphic = l = g[d.shapeType](p).setRadialReference(a.center).attr(b).add(a.group), c.styledMode || l.attr(f).attr({
                            "stroke-linejoin": "round"
                        }).shadow(t, m));
                        l.attr({
            ...
            setVisible: function(a, c) {
                ...
                a !== d.visible && (d.visible = d.options.visible = a = void 0 ===
                    a ? !d.visible : a, b.options.data[b.data.indexOf(d)] = d.options, ["graphic", "dataLabel", "connector", "shadowGroup"].forEach(function(b) {
            ...
            connectorShapes: {
                fixedOffset: function(a, c, g) {
                    var b = c.breakAt;
                    c = c.touchingSliceAt;
                    return ["M", a.x, a.y].concat(g.softConnector ? ["C", a.x + ("left" === a.alignment ? -5 : 5), a.y, 2 * b.x - c.x, 2 * b.y - c.y, b.x, b.y] : ["L", b.x, b.y]).concat(["L",
                        c.x, c.y
                    ])
                },
                ...
                crookedLine: function(c, g, h) {
                    ...
                    h = "left" === b ? d + t + (f + m - d - t) * (1 - h) : m + (d - t) * h;
                    d = ["L", h, c.y];
                    if ("left" === b ? h > c.x || h < g.x : h < c.x || h > g.x) d = [];
                    return ["M", c.x, c.y].concat(d).concat(["L", g.x, g.y])
                }
            },
    ...
    (function(a) {
        ...
        a.distribute = function(b, c, f) {
            ...
            for (b = b.map(function(a) {
                ...
                h = b.length;
                for (l = !1; h--;) 0 < h && b[h - 1].pos + b[h - 1].size > b[h].pos && (b[h - 1].size += b[h].size, b[h - 1].targets = b[h - 1].targets.concat(b[h].targets), b[h - 1].align = .5, b[h -
        ...
        p.prototype.drawDataLabels = function() {
            function b(a, b) {
                var c = b.filter;
                return c ? (b = c.operator, a = a[c.property], c = c.value, "\x3e" === b &&
            ...
            var f = this,
                ...
                u = f.points,
                A, k = f.hasRendered || 0,
                x, C = w(p.defer, !!h.animation),
                y = g.renderer,
                p = d(d(g.options.plotOptions &&
                    g.options.plotOptions.series && g.options.plotOptions.series.dataLabels, g.options.plotOptions && g.options.plotOptions[f.type] && g.options.plotOptions[f.type].dataLabels), p);
            a.fireEvent(this, "drawDataLabels");
            if (m(p) || p.enabled || f._hasPointLabels) x = f.plotGroup("dataLabelsGroup", "data-labels", C && !k ? "hidden" : "visible", p.zIndex || 6), C && (x.attr({
                opacity: +k
            }), k || z(f, "afterAnimate", function() {
                f.visible && x.show(!0);
                x[h.animation ? "animate" : "attr"]({
                    opacity: 1
                }, {
                    duration: 200
                })
                ...
                A.forEach(function(d, k) {
                    var l = d.enabled && !e.isNull && b(e, d),
                        m, q, t, n, p = e.dataLabels ? e.dataLabels[k] : e.dataLabel,
                        r = e.connectors ? e.connectors[k] : e.connector,
                        v = !p;
                    l && (m = e.getLabelConfig(), q = d[e.formatPrefix + "Format"] || d.format, m = G(q) ? c(q, m, g.time) : (d[e.formatPrefix + "Formatter"] || d.formatter).call(m, d), q = d.style, t = d.rotation, g.styledMode || (q.color = w(d.color, q.color, f.color, "#000000"), "contrast" === q.color && (e.contrastColor = y.getContrast(e.color || f.color), q.color = d.inside ||
                        0 > w(d.distance, e.labelDistance) || h.stacking ? e.contrastColor : "#000000"), h.cursor && (q.cursor = h.cursor)), n = {
                        r: d.borderRadius || 0,
                        rotation: t,
                        padding: d.padding,
                        zIndex: 1
                    }, g.styledMode || (n.fill = d.backgroundColor, n.stroke = d.borderColor, n["stroke-width"] = d.borderWidth), a.objectEach(n, function(a, b) {
                        void 0 === a && delete n[b]
                    }));
                    !p || l && G(m) ? l && G(m) && (p ? n.text = m : (e.dataLabels = e.dataLabels || [], p = e.dataLabels[k] = t ? y.text(m, 0, -9999).addClass("highcharts-data-label") : y.label(m, 0, -9999, d.shape, null, null, d.useHTML, null,
        ...
        p.prototype.alignDataLabel = function(a, c, d, g, m) {
            var b = this.chart,
                ...
                r = "justify" === w(d.overflow, "justify");
            if (q && (t = b.renderer.fontMetrics(b.styledMode ? void 0 : d.style.fontSize, c).b, g = h({
                        x: f ?
                            this.yAxis.len - k : l,
                        ...
                        width: n.width,
                        height: n.height
                    }), p ? (r = !1, l = b.renderer.rotCorr(t, p), l = {
                        x: g.x + d.x + g.width / 2 + l.x,
                        y: g.y + d.y + {
                            top: 0,
                            middle: .5,
                            bottom: 1
                        } [d.verticalAlign] * g.height
                    }, c[m ? "attr" : "animate"](l).attr({
                        align: e
                    }), k = (p + 720) % 360, k = 180 < k && 360 > k, "left" === e ? l.y -= k ? n.height : 0 : "center" === e ? (l.x -= n.width / 2, l.y -= n.height / 2) : "right" === e && (l.x -= n.width, l.y -= k ? 0 : n.height), c.placed = !0, c.alignAttr = l) : (c.align(d, null, g), l = c.alignAttr), r && 0 <= g.height ?
                    a.isLabelJustified = this.justifyDataLabel(c, d, l, n, g, m) : w(d.crop, !0) && (q = b.isInsidePlot(l.x, l.y) && b.isInsidePlot(l.x + n.width, l.y + n.height)), d.shape && !p)) c[m ? "attr" : "animate"]({
        ...
        p.prototype.justifyDataLabel = function(a, c, d, g, h, m) {
            var b = this.chart,
                f = c.align,
                k = c.verticalAlign,
                l, n, t = a.box ? 0 : a.padding || 0;
            l = d.x + t;
            0 > l && ("right" === f ? c.align = "left" : c.x = -l, n = !0);
            l = d.x + g.width - t;
            l > b.plotWidth && ("left" ===
                f ? c.align = "right" : c.x = b.plotWidth - l, n = !0);
            l = d.y + t;
            0 > l && ("bottom" === k ? c.verticalAlign = "top" : c.y = -l, n = !0);
            l = d.y + g.height - t;
            l > b.plotHeight && ("top" === k ? c.verticalAlign = "bottom" : c.y = b.plotHeight - l, n = !0);
            n && (a.placed = !m, a.align(c, null, h));
            return n
        };
        g.pie && (g.pie.prototype.dataLabelPositioners = {
            ...
            b.visible && (h.enabled || b._hasPointLabels) && (c.forEach(function(a) {
                    ...
                    var l, n, p = c.length,
                        ...
                        v;
                    if (p)
                        for (b.sortByAngle(c, f - .5), 0 < b.maxLabelDistance && (l = Math.max(0, z - q - b.maxLabelDistance), n = Math.min(z + q + b.maxLabelDistance, g.plotHeight), c.forEach(function(a) {
                            ...
                            P = l = J.natural.y;
                            t && G(d.distributeBox) && (void 0 === d.distributeBox.pos ? M = "hidden" : (N = d.distributeBox.size, P = W.radialDistributionY(d)));
                            delete d.positionIndex;
                            if (h.justify) B = W.justify(d, q, e);
                            else switch (h.alignTo) {
                                case "connectors":
                                    B = W.alignToConnectors(c, f, r, u);
                                    break;
                                case "plotEdges":
                                    B = W.alignToPlotEdges(K,
                                        f, r, u);
                                    break;
                                default:
                                    B = W.radialDistributionX(b, d, P, l)
                            }
                            K._attr = {
                                visibility: M,
                                align: J.alignment
                            ...
                            J.final.x = B;
                            J.final.y = P;
                            w(h.crop, !0) && (I = K.getBBox().width, l = null, B - I < m && 1 === f ? (l = Math.round(I - B + m), O[3] = Math.max(l, O[3])) : B + I > r - m && 0 === f && (l = Math.round(B + I - r + m), O[1] = Math.max(l, O[1])), 0 > P - N / 2 ? O[0] = Math.max(Math.round(-P + N / 2), O[0]) : P + N / 2 > k && (O[2] = Math.max(Math.round(P + N / 2 - k), O[2])), K.sideOverflow = l)
                        }
                ...
                (this.placeDataLabels(), n && this.points.forEach(function(a) {
                    ...
                    if ((K = a.dataLabel) && K._pos && a.visible && 0 < a.labelDistance) {
                        ...
                        if (c = !y) a.connector = y = g.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex + (a.className ? " " + a.className : "")).add(b.dataLabelsGroup), g.styledMode || y.attr({
                            "stroke-width": n,
            ...
            var b =
                ...
                g = c.minSize || 80,
                h, m = null !== c.size;
            m || (null !== d[0] ? h = Math.max(b[2] - Math.max(a[1], a[3]), g) : (h = Math.max(b[2] - a[1] - a[3], g), b[0] += (a[3] - a[1]) / 2), null !== d[1] ? h = Math.max(Math.min(h, b[2] - Math.max(a[0], a[2])), g) : (h = Math.max(Math.min(h, b[2] - a[0] - a[2]), g), b[1] += (a[0] - a[2]) / 2), h < b[2] ? (b[2] = h, b[3] = Math.min(x(c.innerSize || 0, h), h), this.translate(b), this.drawDataLabels && this.drawDataLabels()) : m = !0);
            return m
        });
        g.column && (g.column.prototype.alignDataLabel = function(a, c, d, g, h) {
            var b =
                ...
                m = w(d.inside, !!this.options.stacking);
            ...
            d.align = w(d.align, !b || m ? "center" : k ? "right" : "left");
            d.verticalAlign = w(d.verticalAlign, b || m ? "middle" : k ? "top" :
                "bottom");
            p.prototype.alignDataLabel.call(this, a, c, d, g, h);
            a.isLabelJustified && a.contrastColor && c.css({
    ...
    (function(a) {
        ...
        z.prototype.hideOverlappingLabels = function(a) {
            var c = this,
                h = a.length,
                p = c.renderer,
                g, d, m, n, b, l, f = function(a, b, c, d, f, g, h, l) {
    ...
    (function(a) {
        ...
        v = a.TrackerMixin = {
            ...
            drawTrackerGraph: function() {
                ...
                if (g && !c)
                    for (p = g + 1; p--;) "M" === d[p] && d.splice(p + 1, 0, d[p + 1] - e, d[p + 2], "L"), (p && "M" === d[p] || p === g) && d.splice(p, 0, "L", d[p - 2] + e, d[p - 1]);
                n ? n.attr({
                    d: d
        ...
        l.column && (l.column.prototype.drawTracker = v.drawTrackerPoint);
        ...
        u(F.prototype, {
            ...
            zoom: function(a) {
                ...
                d && !f ? this.showResetZoom() : !d && p(f) && (this.resetZoomButton = f.destroy());
        ...
        u(n.prototype, {
            ...
            setState: function(a, b) {
                var c =
                    ...
                    v = f.chart,
                    x = f.halo,
                    z, F = h && f.markerAttribs;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === g.enabled || a && (n || l && !1 === e.enabled) || a && t.states && t.states[a] && !1 === t.states[a].enabled)) {
                    F && (z = f.markerAttribs(this, a));
                    if (this.graphic) this.state &&
                        this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), v.styledMode || this.graphic.animate(f.pointAttribs(this, a), m(v.options.chart.animation, g.animation)), z && this.graphic.animate(z, m(v.options.chart.animation, e.animation, h.animation)), p && p.hide();
                    else {
                        if (a && e) {
                            h = t.symbol || f.symbol;
                            ...
                            else h && (f.stateMarkerGraphic = p = v.renderer.symbol(h, z.x, z.y, z.width, z.height).add(f.markerGroup),
                                p.currentSymbol = h);
                            !v.styledMode && p && p.attr(f.pointAttribs(this, a))
                        }
                        p && (p[a && v.isInsidePlot(c, d, v.inverted) ? "show" : "hide"](), p.element.point = this)
                    }(c = g.halo) && c.size ? (x || (f.halo = x = v.renderer.path().add((this.graphic || p).parentGroup)), x.show()[b ? "animate" : "attr"]({
                        d: this.haloPath(c.size)
                    }), x.attr({
                        "class": "highcharts-halo highcharts-color-" + m(this.colorIndex, f.colorIndex) + (this.className ? " " + this.className : ""),
                        zIndex: -1
                    }), x.point = this, v.styledMode || x.attr(u({
        ...
        u(b.prototype, {
            ...
            setState: function(a) {
                ...
                if (b.state !== a && ([b.group, b.markerGroup, b.dataLabelsGroup].forEach(function(c) {
                    ...
                    }), b.state = a, !(b.chart.styledMode || f[a] && !1 ===
                        f[a].enabled) && (a && (g = f[a].lineWidth || g + (f[a].lineWidthPlus || 0)), d && !d.dashstyle)))
                    for (g = {
                            "stroke-width": g
                        }, d.animate(g, m(f[a || "normal"] && f[a || "normal"].animation, b.chart.options.chart.animation)); b["zone-graph-" + c];) b["zone-graph-" + c].attr(g), c += 1
            },
    ...
    (function(a) {
        var z = a.Chart,
            ...
            h = a.pick,
            c = a.splat;
        z.prototype.setResponsive = function(c, h) {
            var r = this.options.responsive,
                u = [],
                p = this.currentResponsive;
            !h && r && r.rules && r.rules.forEach(function(g) {
                void 0 === g._id && (g._id = a.uniqueKey());
                this.matchResponsiveRule(g, u, c)
            }, this);
            h = a.merge.apply(0, u.map(function(c) {
            ...
            u = u.toString() ||
                void 0;
            u !== (p && p.ruleIds) && (p && this.update(p.undoOptions, c), u ? (p = this.currentOptions(h), p.isResponsiveOptions = !0, this.currentResponsive = {
                ruleIds: u,
                mergedOptions: h,
                undoOptions: p
            }, this.update(h, c)) : this.currentResponsive = void 0)
        };
        ...
        z.prototype.currentOptions = function(h) {
            function r(h, p, g, d) {
                ...
                a.objectEach(h, function(a, b) {
                    if (!d && -1 < ["series", "xAxis", "yAxis"].indexOf(b))
                        for (a = c(a), g[b] = [], m = 0; m < a.length; m++) p[b][m] && (g[b][m] = {}, r(a[m], p[b][m], g[b][m], d + 1));
                    else G(a) ? (g[b] = F(a) ? [] : {}, r(a, p[b] || {}, g[b], d + 1)) : g[b] = p[b] || null
                })
            }
            var w = {};
            r(h, this.options, w, 0);
            return w
        }
    })(I);
    return I
