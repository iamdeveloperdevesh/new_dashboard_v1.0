			...
			rules:  {
				...
				nominee_fname: 
					...
					submitHandler: function (form) 
					{
						...
						if(agent_details == 0 || customer_details == 0 || policy_details == 0){
							swal({
									title: "Alert",
									text:"Please SAVE the values entered so far to proceed with new Section!",
									type: "warning",
...
if(response.tl_name != null){
						...
						var tl_name = '';
                                        ...
                                        var res_vendor = response.vendor.toUpperCase();
                                        $("#tl_name").val(tl_name);
				/*	$("#tl_name").val(response.tl_name.toUpperCase()); */
					...
					setTimeout(function(){ $("#axis_vendor option:contains("+res_vendor+")").attr("selected", true);
