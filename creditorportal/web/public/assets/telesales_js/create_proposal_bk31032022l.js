   ...
   var get_premium = '';
    ...
    var TELE_HEALTHPROINFINITY_GHI = '463';
	var TELE_HEALTHPROINFINITY_GPA = '464';
	var TELE_HEALTHPROINFINITY_GHI_GPA = '463,464';
	var TELE_HEALTHPROINFINITY_GHI_ST = '465';
...
//debugger;
						...
						//upendra - 29/06/2021 new health pro - rater changes
						if($('#plan_name').val() == 'T01'){
							getPremiumNew();
						}
					}
...
/* end */			
			...
			var all_data = $("#payment_details").serialize();
						...
						$("#payment_details_tbody").html(str);
							...
							//maker-checker - upendra
							$("#payment_details :input").attr("disabled", true);
							$("#audit_btn").attr("disabled", false);
							 $("#pre_send").attr("disabled", false);
						}
						});
...
function agent_cust_prefilled(response)
{
	...
	if((product_id == "T03") && (emp.new_remarks)){
...
if(is_maker_checker == "yes"||is_maker_checker_edit=="yes"){
	...
	//alert(base_agent_vendor);
	$("#axis_vendor option:contains("+base_agent_vendor+")").attr("selected", true);
	 //$("#axis_vendor").find("option[text=" + base_agent_vendor + "]").attr("selected", true);
//	proposal_create_check();
