                ...
                <ul class="sidebar-menu">
					...
					<?php if(in_array('CreditorList',$this->RolePermission) || in_array('CreditorBranchList',$this->RolePermission) ){?>
						<li><a class="sidebar-header" href="#"><i data-feather="users"></i>
							<span>Partners</span> <i class="fa fa-angle-right pull-right"></i></a>
								<ul class="sidebar-submenu">
								<?php if(in_array('CreditorList',$this->RolePermission)){?>
									<li><a href="<?php echo base_url();?>creditors"><i class="fa fa-circle"></i><span>Partners</span></a></li>
								<?php }?>
								<?php if(in_array('CreditorBranchList',$this->RolePermission)){?>
									<li><a href="<?php echo base_url();?>creditorbranches"><i class="fa fa-circle"></i><span>Partner Branches</span></a></li>
								<?php }?>	
								</ul>
						</li>
					<?php }?>
