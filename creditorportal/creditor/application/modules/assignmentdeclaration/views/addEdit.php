			...
			<div class="row">
				<div class="col-lg-6">
					<div class="page-header-left">
						<h3>Assignment Declaration</h3>
					</div>
				</div>
				<div class="col-lg-6">
					<ol class="breadcrumb pull-right">
						<li class="breadcrumb-item"><a href="<?php echo base_url()?>assignmentdeclaration/addEdit"><i data-feather="home"></i> </li>
						<li class="breadcrumb-item active">Assignment Declaration</li></a>
					</ol>
				</div>
			</div>
		</div>
							...
							<div class="tab-pane fade active show"  aria-labelledby="account-tab">
								<form  id="form-validate" method="post" action="#">
									...
									<div class="pull-center" >
										...
										<a href="<?php echo base_url();?>assignmentdeclaration" class="btn btn-primary">Cancel</a>
									</div>
								</form>
							</div>
						</div>
