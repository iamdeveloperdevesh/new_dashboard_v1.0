            ...
            <div class="box-content">
                <?php if(!isset($policyview)){ ?>
                    ...
                    <div id="collapseOne" class="collapse in" aria-labelledby="headingOne" data-parent="#accordionExample">
                   		<form class="form-horizontal" id="form-plan" method="post" enctype="multipart/form-data">
                        	...
                        	<div class="row">
                        	        ...
                        	        <div class="form-group">
            							...
            							<select class="form-control" name="creditor">
        							        <?php foreach($datalist->creditors as $creditor){ ?>
            							        <option value="<?php echo $creditor->creditor_id; ?>" <?php if($datalist->details[0]->creditor_id == $creditor->creditor_id){echo "selected";} ?>><?php echo $creditor->creaditor_name; ?></option>
            							    <?php } ?>
            							</select>
            						</div>
                        	    </div>
                        	    ...
                        	    <div class="col-sm-4">
                        	        <div class="form-group">
            							...
            							<input class="form-control planname" type="text" data-id="<?php echo $datalist->plan_id; ?>" name="plan_name" value="<?php echo $datalist->details[0]->plan_name; ?>" placeholder="" />
    						...
    						<div class="row">
    						    <div class="col-sm-3 col-xs-6">
                        	       <div class="form-group">
                        	           <a href="javascript:void(0)" class="btn btn-success btn-lg" id="continuebtn">Countinue</a>
                    	           </div>
                        	   </div>
                        	   <div class="col-sm-3 col-xs-6">
                        	       <div class="form-group">
                        	...
                        	<div class="row">
                                   <div class="col-md-4">
                                      <div class="form-group">
                                         ...
                                         <select id="policySubType" name="policySubType" class="form-control">
                                			...
                                			?>
                                            <option value="<?php echo $detail->policy_id; ?>" <?php if(isset($datalist->policydetails) && $datalist->policydetails[0]->policy_id == $detail->policy_id){echo "selected"; } ?>><?php echo $detail->policy_sub_type_name; ?></option>
                                			<?php } ?>
                                         </select>
                                      </div>
                                   </div>
                                   ...
                                   <div class="col-md-4">
                                      <div class="form-group"> 
                                          ...
                                          <input class="form-control policyno" type="number" data-id="<?php echo $detail->policy_id; ?>" value="<?php if(isset($datalist->policydetails)){echo $datalist->policydetails[0]->policy_number; } ?>" id="policyNo" name="policyNo"> 
                                          <div class="error"><span class="policyerror"></span></div>
                                      </div>
                                   </div>
                                	<div class="col-md-4" style="display:flex;">
                                	    <div class="form-check custom-control custom-checkbox" style="margin-top: 46px;"> <input type="checkbox" class="form-check-input custom-control-input" name="mandatory" value="1" id="mandatory_option" <?php if(isset($datalist->policydetails) && $datalist->policydetails[0]->is_optional == 0){echo "checked"; } ?>> <label class="form-check-label custom-control-label" for="mandatory_option"> Mandatory </label> </div>
                                        <div class="form-check custom-control custom-checkbox" id="combo_flag" style="margin-top: 46px; margin-left: 46px;"> <input type="checkbox" class="form-check-input custom-control-input" value="1" name="combo" id="Combo_option" <?php if(isset($datalist->policydetails) && $datalist->policydetails[0]->is_combo == 1){echo "checked"; } ?>> <label class="form-check-label custom-control-label" for="Combo_option"> Combo </label> </div>
                                	</div>
                                   ...
                                   <div class="col-md-4">
                                      <div class="form-group">
                                         ...
                                         <select id="pdf_type" name="pdf_type" class="form-control">
                                            <option value="">Select</option>
                                            <option value="1" <?php if(isset($datalist->policydetails) && $datalist->policydetails[0]->pdf_type == 1){echo "selected"; } ?>>I</option>
                                            <option value="2" <?php if(isset($datalist->policydetails) && $datalist->policydetails[0]->pdf_type == 2){echo "selected"; } ?>>C1</option>
                                            <option value="3" <?php if(isset($datalist->policydetails) && $datalist->policydetails[0]->pdf_type == 3){echo "selected"; } ?>>C2</option>
                                         </select>
                                      </div>
                                   </div>
								   <div class="col-md-4">
                                      <div class="form-group">
                                         ...
                                         <select id="premium_type" name="premium_type" class="form-control">
                                            <option value="1" <?php if(isset($datalist->policydetails) && $datalist->policydetails[0]->premium_type == 1){echo "selected"; } ?>>Absolute</option>
                                            <option value="0" <?php if(isset($datalist->policydetails) && $datalist->policydetails[0]->premium_type == 0){echo "selected"; } ?>>Per Mile rate</option>
                                         </select>
                                      </div>
                                   </div>
                                   <div class="col-md-4">
                                      <div class="form-group">
                                         ...
                                         <select id="masterInsurance" name="masterInsurance" class="form-control">
                                            ...
                                            <option value="<?php echo $insurer->insurer_id; ?>" <?php if(isset($datalist->policydetails) && $datalist->policydetails[0]->insurer_id == $insurer->insurer_id){echo "selected"; } ?>><?php echo $insurer->insurer_name; ?></option>
                                			<?php } ?>
                                         </select>
                                      </div>
                                   </div>
                                   ...
                                   <div class="col-md-4">
                                      <div class="form-group"> <label class="col-form-label">Policy Start Date</label> <input class="form-control datepicker" type="text" value="<?php if(isset($datalist->policydetails)){echo $datalist->policydetails[0]->policy_start_date; } ?>" id="policyStartDate" name="policyStartDate" autocomplete="off"> </div>
                                   </div>
                                   <div class="col-md-4">
                                      <div class="form-group"> <label class="col-form-label">Policy End Date</label> <input class="form-control enddate" type="text" value="<?php if(isset($datalist->policydetails)){echo $datalist->policydetails[0]->policy_end_date; } ?>" id="policyEndDate" name="policyEndDate" autocomplete="off"> </div>
                                   </div>
    						...
    						<div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="membercount" value="<?php if(isset($datalist->policydetails)){echo $datalist->policydetails[0]->max_member_count; } ?>" class="form-control membercount" />
                                    </div>
                                </div>
                            </div>
                            <div class="row memberlist">
                                <?php if(isset($datalist->family_construct) && count($datalist->family_construct) > 0){ $i = 0;
                                    ...
                                    <div class='col-sm-4 form-group'>
                                    	<select data-id="<?php echo $i; ?>" name='member[]' class='form-control memberselect'>
                                    	    <?php foreach($datalist->members as $member){
                                                ...
                                                echo "<option value='$member->id' selected>$member->member_type</option>";}else{
                                   ...
                                   <div class="col-md-6">
                                      <div class="form-group">
                                         ...
                                         <select id="sum_insured_type" name="sum_insured_type" class="form-control">
                                            ...
                                            <option value="<?php echo $type->suminsured_type_id ;?>" <?php if(!empty($datalist->si_type[0]->suminsured_type_id) && ($datalist->si_type[0]->suminsured_type_id == $type->suminsured_type_id)){ echo "selected";} ?>> <?php echo $type->suminsured_type ;?> </option>
                                			<?php } ?>
                                         </select>
                                      </div>
                                   </div>
                                   <div class="col-md-6">
                                      <div class="form-group">
                                         ...
                                         <select id="companySubTypePolicy" name="companySubTypePolicy" class="form-control valid" aria-invalid="false">
                                            ...
                                            <option value="<?php echo $premium->si_premium_basis_id ;?>" <?php if(!empty($datalist->premium_basis[0]->si_premium_basis_id) && ($datalist->premium_basis[0]->si_premium_basis_id == $premium->si_premium_basis_id)){ echo "selected";} ?>> <?php echo $premium->si_premium_basis ;?> </option>
                                			<?php } ?>
                                         </select>
                                      </div>
                                   </div>
                                   <div id="fileUploadAgeDiv" style="<?php if( !empty($datalist->premium_basis) && ($datalist->premium_basis[0]->si_premium_basis_id == 4)){ echo "display: block"; }else{echo "display: none";} ?>" class="col-md-12">
                                      <div class="row">
                                         ...
                                         <div class="col-md-6" style="margin-top:30px;"> 
                                            <a href="/public/assets/agefamilyExcel.xls" class="btn btn-danger btn-lg download-btn" download="ageExcel.xls">Download Format </a> 
                                         </div>
                                      </div>
                                   </div>
                                   <div id="fileUploadfamilyDiv" style="<?php if( !empty($datalist->policy_premium) && ($datalist->premium_basis[0]->si_premium_basis_id == 2)){ echo "display: block"; }else{echo "display: none";} ?>" class="col-md-12">
                                      <div class="row">
                                         <div class="col-md-6" style="margin-top: 12px;">
                                            <div class="form-group"> 
                                                <label>Upload by family Construct</label> 
                                               <input type="file" name="ageFile" class="form-control" id="familyConstructFile"> 
                                            </div>
                                         </div>
                                         <div class="col-md-6" style="margin-top: 20px;"> 
                                            <a href="/public/assets/ageExcel.xlsx" class="btn btn-danger btn-lg download-btn" download="ageExcel.xlsx">Download Format </a> 
                                         </div>
                                      </div>
                                   </div>
                                   <div id="fileUploadfamilyageDiv" style="<?php if( !empty($datalist->policy_premium) && ($datalist->premium_basis[0]->si_premium_basis_id == 3)){ echo "display: block"; }else{echo "display: none";} ?>" class="col-md-12">
                                      <div class="row">
                                         <div class="col-md-6" style="margin-top: 10px;">
                                            <div class="form-group"> 
                                               <label>Upload by family and age Construct</label> 
                                               <input type="file" name="ageFile" class="form-control" id="agefamilyConstructFile"> 
                                            </div>
                                         </div>
                                         <div class="col-md-6" style="margin-top: 20px;">
                                            <a href="/public/assets/agefamilyExcel.xls" class="btn btn-danger btn-lg download-btn" download="agefamilyExcel.xls">Download Format </a> 
                                         </div>
                                      </div>
                                   </div>
                                   <div class="col-md-12">
                                      <table id="tableSiflat" class="responsive-table" style="margin: 5px 5px 5px 13px; <?php if( !empty($datalist->policy_premium) && ($datalist->premium_basis[0]->si_premium_basis_id == 1)){ echo "display: block"; }else{echo "display: none";} ?>" border="0">
                                         <tbody id="add_si_tbody">
                                            
                                            <?php if(!empty($datalist->policy_premium) && ($datalist->premium_basis[0]->si_premium_basis_id == 1) && !empty($datalist->policy_premium)){ $i = 1; foreach($datalist->policy_premium as $premium) { ?>
                                            <tr>
                                                <td style="text-align: right;" class="row mt-4"> 
                                                	<div class="col-md-5">
                                                		<label style="font-size: 13px; float: left;">Enter Sum Insured</label>
                                                		<input type="number" placeholder="Sum Insured" class="form-control" value="<?php if(isset($premium->sum_insured)) echo $premium->sum_insured;  ?>" name="sum_insured_opt1[]" autocomplete="off">
                                                	</div>
                                                	<div class="col-md-5">
                                                		<label style="font-size: 13px; float: left;">Enter Premium</label>
                                                		<input type="number" value="<?php if(isset($premium->premium_rate)) echo $premium->premium_rate;  ?>" placeholder="premium" class="form-control" name="premium_opt[]" autocomplete="off"> 
                                                	</div>
                                                	<div class="col-md-2">
                                                		<label  style="font-size: 13px; float: left;">Is Taxable</label>  
                                                		<input type="checkbox" class="form-control taxchk" <?php if($premium->is_taxable == 1) echo "checked";  ?>><input type="hidden" class="tax_opt" name="tax_opt[]" value="<?php echo $premium->is_taxable;  ?>" /> 
                                                	</div>
                                                </td>
                                                <?php if($i == 1){?>
                                                    <td id="btn_add_si_flat" style="width:15%;text-align: right;"><a><i class="fa fa-plus" aria-hidden="true"></i></a>  </td>
                                                <?php } else { ?>
                                                    <td name="del_btn_opt" class="del_btn_opt" style="width:15%;text-align: right;">
                                                    	<a><i style="margin-top: 15px;" class="fa fa-trash" aria-hidden="true"></i></a>
                                                    </td>
                                                <?php } ?>
