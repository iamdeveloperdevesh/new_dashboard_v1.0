			...
			<div class="row">
				...
				<div class="col-lg-6">
					<ol class="breadcrumb pull-right">
						...
						<li class="breadcrumb-item active">Insurer</li>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="card">
			<div class="card-body">
				<div class="btn-popup pull-right">
					<p><a href="<?php echo base_url();?>insurer/addEdit" class="btn btn-primary icon-btn"><i class="fa fa-plus"></i>Add Insurer</a></p>
				...
				<div class="row">
					<div class="col-sm-12 col-xs-12">
						<div class="dataTables_filter searchFilterClass form-group">
							<label for="firstname" class="control-label">Insurer Name</label>
				...
				<div class="row">
				    <div class="col-sm-12 col-xs-12">
    					<div class="control-group clearFilter">
    						<div class="controls">
    							<a href="insurer" tabindex="50"><button class="btn" style="margin:32px 10px 10px 10px;" tabindex="51">Clear Search</button></a>
    						</div>
    					</div>
    				</div>
				</div>
