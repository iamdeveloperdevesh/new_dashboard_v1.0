	...
	<form class="form-horizontal" id="finalform" method="post" enctype="multipart/form-data">
		...
		<div class="card-header" id="headingThree">
			...
			<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
					...
					<div class="col-lg-3"> 
						<div class="form-group"> 
							...
							<select class="form-control" name="mode_of_payment" id="mode_of_payment">
								...
								<option value="<?php echo $paymode->payment_mode_id; ?>" <?php if(!empty($leaddetails->proposal_details) && ($leaddetails->proposal_details[0]->mode_of_payment ==$paymode->payment_mode_id)){echo "selected";} ?>><?php echo $paymode->payment_mode_name; ?></option>
								<?php } ?>
							</select>
						</div> 
					</div>
				...
				<div class="chequedetails" <?php if(!empty($leaddetails->proposal_details) && ($leaddetails->proposal_details[0]->mode_of_payment == 2)){ ?>style="display:block" <?php }else{ ?>style="display:none" <?php } ?>>
				<div class="row">
					<div class="col-md-3"> 
						<div class="form-group"> 
