			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-2 col-12 txt-lr">
						...
						<a href="<?php echo base_url();?>uwproposals"><button class="btn cnl-btn">Clear Search</button></a>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	function rejectProposal(id)
	{
		...
		{
			$.ajax({
				url: "<?php echo base_url().$this->router->fetch_module();?>/uwproposals/rejectProposal/"+id,
				async: false,
				type: "POST",
	...
	function acceptProposal(id)
	{
		...
		{
			$.ajax({
				url: "<?php echo base_url().$this->router->fetch_module();?>/uwproposals/acceptProposal/"+id,
				async: false,
				type: "POST",
				success: function(data2){
					data2 = $.trim(data2);
