...
//echo $this->db->last_query();exit;
  ...
  //dedupe logic update unique ref no
	...
	//	echo 123;die;
        ...
        // if($resArr['unique_ref_no'] == ''){
            ...
            // $unique_ref_no = $this->generate_unique_ref_no($emp_id);
 ...
 /*dedupe logic changes function to generate unique reference no*/
    ...
    public function generate_unique_ref_no($length = 12)
    {
		
		$unique_ref_no = $this->getRandomUniqueNumber($length);
        //$unique_ref_no = time().$emp_id;
        $EmployeeData = $this
            ->db
		...
		if(empty($EmployeeData)){
            ...
            $this->generate_unique_ref_no($length);
        }
	...
	public function tele_update_ref_no_vl(){
		...
		$output_query = $this
		->db
		->query("SELECT ed.product_id, ed.unique_ref_no, ed.emp_id		FROM 
    ...
    public function check_dedupe_logic(){
		...
		$dedupe_yes_no = dedupe_renewal_check($already_cust_id_count);
        ...
        if($adult_count == 2 && $dedupe_yes_no == 1){
		...
		$count_qry = "SELECT p.status from employee_details ed , proposal p where ed.emp_id = p.emp_id and ed.unique_ref_no = '".$unique_ref_no."' AND ed.product_id = '".$product_id."' AND ed.emp_id != '".$emp_id."' AND p.status IN ('Success','Payment Pending','Payment Received') group by ed.emp_id";
            ...
            if($proposal_count >= 3 && $dedupe_yes_no == 1){
...
public function delete_member()
	...
	public function delete_member_bk_19032022()
	{
		extract($this
            ->input
            ->post());
...
//echo $this->db->last_query();exit;
	...
	public function update_tele_net_premium(){
		...
		// $net_premium_array = ["10338","14660","18050","20931","13728","16694","10847","15423","18982","22033","14406","17457","11270","16101","19830","23050","14999","18135","14321","20508","24406","27795","18220","22371","15423","22033","26270","29999","19660","23897","16524","23643","28135","32118","21016","25423","1695","3390","2542.372881","5085","3390","6780","4491","6355","7542","8643","5677","6270","2372","3135","3474","3728","2711","2965","4067","5677","6694","7626","5084","5592","3558","4914","5762","6525","4406","4830","9745","13897","15847","17711","11694","13558","5084","7118","7966","8728","5932","6694","8643","12287","13982","15592","10338","12033","7541","10762","12118","13389","8897","10507","6779.662","9745.763","12288.136","14406.78","9322.034","11864.407","8898.306","12288.136","15677.967","18220.339","11864.407","15254.238","9322.034","13559.323","16525.424","19915.255","13050.848","15932.204","9745.763","13983.051","17372.882","20254.238","13474.577","16101.695","10084.746","14406.78","17796.611","20677.967","13559.323","16525.424","7203.39","10169.492","12711.865","14830.509","9745.763","12288.136","9322.034","12711.865","16101.695","18644.068","12288.136","15677.967","11016.95","14830.509","18644.068","22457.628","14406.78","18220.339","12711.865","17372.882","22033.899","25847.458","16949.153","21610.17","13983.051","19491.526","24237.289","27627.119","18220.339","22203.39","254.2372881","508.4745763","508.4745763","1016.949153","762.7118644","1525.423729","1016.949153","2033.898305","1271.186441","2542.372881","1440.677966","2881.355932","2881.355932","5762.711864","4322.033898","8644.067797","5762.711864","11525.42373","7203.389831","14406.77966","4406.779661","8813.559322","8813.559322","17627.11864","13220.33898","26440.67797","17627.11864","35254.23729","22033.89831","44067.79661"];
