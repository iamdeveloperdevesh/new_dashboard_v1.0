            ...
            if ($checksum != $hashData) {
                ...
                if (empty($aJSONData)) {
                    ...
                    if ($isValid) {
						...
						// quote expired in reverse feed - added by sonal
						...
						if(count($quote_exp_check)>0)
						{
						 ...
						 return false;
                            ...
                            else{$this->session->set_flashdata('flashdata_lead_continue',$data); 
                            redirect('/continue_lead_data');}//added  else  for quote expired in reverse feed - added by sonal	
                        }
...
// quote expired in reverse feed - added by sonal
    ...
    function dropoff_journey($emp_id_encrypt,$send_type) {
        ...
        $aD2CSession['d2c_session'] = array('emp_id' => $emp_id_encrypt, 'product_id' => $this->productCode, 'policy_parent_id' => $val['policy_parent_id'], 'dropoff' => true);
