...
.borderBottm{
    border-bottom: 1px dashed #c3b0b0;
}
                                ...
                                <div class="form-group dropdown_product_m_t_b_p">
                                    ...
                                    <?php }?>
                                                                            ...
                                                                            <div class="form-group dropdown_product_m_t_b_p">
                                                                                ...
                                                                                <label class="over_border_txt_proposal_add">Sum Insured <span style="color:#e53636 ">*</span></label>
                                                                                <div class="help-block with-errors"></div>
                                                                            </div>
                                                                            <?php
...
-->
                            ...
                            foreach ($quote_info['policy_details'] as $policy_val) {
                            $pol_id=$policy_val['policy_id'];
                            $dependent_on_policy_id=$policy_val['dependent_on_policy_id'];
                            if ($policy_val['is_combo'] == 0 && $policy_val['is_optional'] == 1) {
                            ...
                            <div class="borderBottm"></div>
                            <div class="custom-control custom-checkbox"><div>
                                    <input type="hidden" name="dep_pol_<?php echo $k;?>" id="dep_pol_<?php echo $k;?>" value="<?php echo $dependent_on_policy_id; ?>">
            ...
            <script>
                ...
                $('.clickcheck').change(function() {
                  ...
                  /*  var id=$(this).attr('id');
                    var arr=id.split('_');
                    var cnt=arr[1];
                    var dep_pol = $('#dep_pol_'+cnt).val();
                    if(dep_pol != '' || dep_pol != null){
                        $(".clickcheck[value="+dep_pol+"]").prop("checked","true");
                    }*/
                    if(this.checked) {
