<?php //var_dump($premium_details); exit;?>
<html>
            ...
            <div>
                <div class="table_content_space">
                    <table>
                        ...
                        <tr>
                            <td>Product Name</td>
                            <td style="font-weight: bold;"><?php echo $creaditor_name.' - '.$plan_name ?></td>

                        </tr>
                        <tr>
                            <td>Plan Name</td>
                            <td style="font-weight: bold;"><?php echo $plan_name.' - ' .$policy_sub_type_name ?> </td>
                            <td>Member Id</td>
                            <td style="font-weight: bold;">HIN100011795</td>
                        </tr>
                        <tr>
                            <td>Residential Address of Insured Person</td>
                            <td style="font-weight: bold;"> <?php echo $addr_details; ?></td>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: bold;"><?php echo $mobile_no; ?>
                            </td>
                        </tr>
                    </table>
                </div>
           ...
           <!-- <div class="table_content_space">
            ...
            <div class="table_content_space new-page">
                ...
                <table border=2 cellpadding=4>
                   ...
                   <!-- <tr>
                        <td>Net Premium with Tax</td>
                        <td><?php /*echo  $premium_details['premium_with_tax']; */?> </td>
                    </tr>-->
                    <tr>
                        <td>Tax Percent</td>
                        <td><?php echo  round((($premium_details['premium_with_tax']-$premium_details['premium'])/$premium_details['premium']) *100)."%"; ?></td>
                    </tr>
                    <!--  <tr>
                          <td>SGST / UTGST (9%)
                          </td>
            ...
            <div class="pdf_flex" style="text-align: center;">
                <p class=" card_1111"> GST No :<span style="font-weight: bold;">27AANCA4062G1ZN</span></p>
            ...
            <div class="fl-card">
                ...
                <div class="fl-2 ">
                    ...
                    <div class="fl-card fl-cd-22">
                        ...
                        <div class="fl-22">
                            <img src="<?php echo base_url().'assets/coi_images/logo-ad.png';?>" width="100" style="margin-top: -4px;">
                        </div>
                    </div>
