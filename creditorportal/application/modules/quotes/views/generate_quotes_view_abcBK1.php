                                                        ...
                                                        <div class="head-del">
                                                            ...
                                                            <div class="body-product-del mt-4 mb-3">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <p class="sum-del sum-delNew mt-4">Sum Insured<br>
...
<div class="modal fade" id="editdetails-float" style="display: none; padding-right: 16px; padding-left: 0px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content login-card">
            ...
            <input id="prem_info" name="prem_info" value="<?php echo $policy_id_imp; ?>">
            <script>
...
// return;
                                ...
                                if (res.status == 200) {
                                    ...
                                    $('.cover_det').remove();
                                    $('.sum-delNew').html('<p style="margin-bottom: 0px">Sum Insured</p>');
