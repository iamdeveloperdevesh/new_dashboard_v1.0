...
$region_admin = $telesession['is_region_admin'];

if($admin=='1'&&$region_admin=='1'){
    $disable_axis_process='disabled';
    $axis_process_selected_inbound=$telesession['axis_process']=='Inbound Phone Banking'?'selected':'';
    $axis_process_selected_outbound=$telesession['axis_process']=='Outbound Call Center (OCC)'?'selected':'';

}else{
    $disable_axis_process='';
    $axis_process_selected_inbound='';
    $axis_process_selected_outbound='';
...
<input type = "hidden" id = "check_lob" value = "<?php echo $telesession['axis_process']; ?>">
            ...
            <div class="col-lg-10 table-responsive pad-0 mt-3">
                <div class="card">
                    <div class="card-body card-style">
                        ...
                        <?php
                        // handle this session condition for view changes
                            ...
                            <div class="row mt-2">
                                <div class=<?php echo ($admin == '1') ? "col-md-2" : "col-md-3" ?>>
                                    <div class="form-group">
                                        ...
                                        <input class="form-control search" maxlength="10" name="mobno" type="text"
                                ...
                                <div class=<?php echo ($admin == '1') ? "col-md-2" : "col-md-3" ?>>
                                    <div class="form-group">
                                        ...
                                        <input class="form-control search" name="sakshamid" type="text"
                                ...
                                <?php if ($admin == '1') {?>
                                    <div class=<?php echo ($admin == '1') ? "col-md-2" : "col-md-3" ?>>
                                        <div class="form-group">
                                            <!--<label for="example-text-input" class="col-form-label">Enter Modified Date</label>-->
                                            <label for="example-text-input" class="col-form-label">Enter Lead Generation Date</label>
                                            <input class="form-control search" name="moddate" type="text"
                                                   placeholder="Search By Generation Date">
                                        </div>
                                    </div>
                                    <!-- ankita changes -->
                                    <div class=<?php echo ($admin == '1') ? "col-md-2" : "col-md-3" ?>>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control search" name="issuancedate" type="text"
                                    ...
                                    <div class=<?php echo ($admin == '1') ? "col-md-2" : "col-md-3" ?>>
                                        <div class="form-group">
                                            ...
                                            <select name="axis_process_filter" id="axis_process_filter" class='form-control'
                                                    placeholder='Search By Status' <?php echo $disable_axis_process; ?>>
                                                <option value="">Select Axis Process</option>
                                                <option value="Inbound Phone Banking" <?php echo $axis_process_selected_inbound;  ?>>Inbound Phone Banking</option>
                                                <option value="Outbound Call Center (OCC)" <?php echo $axis_process_selected_outbound;  ?>>Outbound Call Center (OCC)</option>
                                            </select>
                                        </div>
                                    </div>
                                <?php }?>
                                ...
                                <input type = "hidden" id = "check_if_agent"  value="0">
                                ...
                                <?php
                                    ...
                                    ?>
                                    <input type = "hidden" id = "check_if_agent"  value="1">
                                ...
                                <div class="col-md-12 table-responsive" id="lead_table_div" <?php echo $style_table; ?>>
                                    <table class="display" id="leadMasterTable"
                                           width="100%" >
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($admin == '1') {?><th data-id='35' class="blue_bg_header no-sort">COI</th>
                                            ...
                                            <?php if ($admin != '1') {?>
                                                ...
                                                <!-- //upendra - maker/checker - 30-07-2021 - if else condition -->
                                                <?php
...
<script>
    ...
    var global_show = "hide";

    var agent_show = $("#check_if_agent").val();

    if(agent_show == 1){
        var global_agent_show = "hide";
    }
    else{
        var global_agent_show = "show";
    }
...
// 03-02-2022 - SVK005
    ...
    $(document).ready(function () {
        ...
        // 	}
        // });
        if($('#axis_process').val()=='Outbound Call Center (OCC)'){
            var cust_mandetory_flag = true;
            // alert('inb');
        }else{
            var cust_mandetory_flag = false;
            // alert('out');
        }


        $.validator.addMethod('customer_id', function (value, element, param) {
