                ...
                if (!isset($policyview)) {
                    ...
                    <form class="form-horizontal" id="form-plan" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="control-group form-group col-md-4 mb-3">
                                        ...
                                        <div class="form-check custom-control custom-checkbox"> 
                                            <input type="checkbox" class="form-check-input custom-control-input" name="self_mandatory" value="1" id="self_mandatory" <?php   if($datalist->details[0]->self_mandatory==1) echo 'checked'; ?> >
                                ...
                                <div class="control-group form-group col-md-12 table-responsive row">
                            ...
                            <div class="row" id="addplanbtn">
                                <div class="col-md-1 col-6 text-left ml-5">
