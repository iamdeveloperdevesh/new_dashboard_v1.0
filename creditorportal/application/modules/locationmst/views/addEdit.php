					...
					<div class="row">
						<div class="col-md-3 mb-3">
							...
							<div class="input-group">
								<input id="location_name" name="location_name" type="text" class="form-control no-autofill-bkg" placeholder="Enter location" aria-describedby="inputGroupPrepend" value="<?php if(!empty($getDetails[0]['location_name'])){echo $getDetails[0]['location_name'];}?>" />
