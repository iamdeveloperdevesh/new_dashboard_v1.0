			...
			<div class="cre-head">
				<div class="row">
					<div class="col-md-10 col-10">
						<p>Discrepancy Proposals - <i class="ti-user"></i></p>
					</div>
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-2 col-12 txt-lr">
						...
						<a href="<?php echo base_url();?>discrepancyproposals"><button class="btn cnl-btn">Clear Search</button></a>
					</div>
				</div>
			</div>
		</div>
					...
					<table class="dynamicTable table table-bordered non-bootstrap display pt-3 pb-3">
						<thead class="tbl-cre">
							<tr>
                                ...
                                <th>Mobile</th>
                                <th>Email</th>
								<th data-bSortable="false">Discrepancy Type</th>
								<th data-bSortable="false">Discrepancy Subtype</th>
...
<script type="text/javascript">
	...
	document.title = "Discrepancy Proposals";
</script>