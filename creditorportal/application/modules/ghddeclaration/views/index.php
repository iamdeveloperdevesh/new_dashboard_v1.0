			...
			<div class="cre-head">
				<div class="row">
					<div class="col-md-10 col-10">
						<p>GHD Declarations - <i class="ti-user"></i></p>
					</div>
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-2 col-12 text-center">
						...
						<a href="<?php echo base_url();?>ghddeclaration"><button class="btn cnl-btn fl-right">Clear Search</button></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card">
			<div class="cre-head">
				<div class="row">
					...
					<?php if(in_array('GHDDeclarationAdd',$this->RolePermission)){?>
						<div class="col-md-4 col-6">
							<a href="<?php echo base_url();?>ghddeclaration/addEdit">
								<button class="btn btn-sec add-btn fl-right">Add Declaration <span class="display-none-sm"><span class="material-icons spn-icon">add_circle_outline</span></span></button>
							</a>
						</div>
					<?php }?>
			</div>
...
<script>
	function deleteData(id)
	{
		...
		{
			$.ajax({
				url: "<?php echo base_url().$this->router->fetch_module();?>/ghddeclaration/delRecord/"+id,
				async: false,
				type: "POST",
	...
	document.title = "GHD Declaration";
</script>