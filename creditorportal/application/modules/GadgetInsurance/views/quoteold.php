        ...
        <div class="row">
            <div class="col-sm-12 dflex-btn">
                ...
                <div class="quotebtn cmp_srt">
                    <button class="btn btn-default" type="button" onclick="compareBtncClick()">
                ...
                <div class=" qutbox1 quotedetail">
                    <div class="row dflex quotebottom">
                        <div class="col-md-4">
                            ...
                            <button class="btn btn-orange btn-sm" data-toggle="modal"
                        ...
                        <div class="col-md-6">
                            ...
                            if (count($item->features) > 0) {
                                ...
                                <p><img src="/assets/gadget/img/icon.png">Theft or robbery</p>
                                <p><img src="/assets/gadget/img/icon.png">Protection against accidental damage</p>
                            <?php }
                            ?>
                        </div>
                        <div class="col-md-2">
