...
//            print_r($data_marine);die;
         ...
         //   print_r($addMarineDetails);die;
            ...
            $response_mail_sent=checkdailymailsent($creditor_id,'status_cover');
                ...
                if($response_cover['status'] != 0) {
                    ...
                    if ($response_cover['status'] == 201) {
                        if($response_mail_sent == 0) {
                            $mail = sendMailCoverbalance($ceditor_email, $creaditor_name, $cover_limit, $cover_balance, $cover_collection_amt, $response_cover['msg']);
                            $resss = updatedailymail($creditor_id, 'status_cover');
                        }
                        insert_application_log(encrypt_decrypt_password($checkDetails['data']['lead_id'], 'D'), 'Cover Balance', json_encode($response_cover),json_encode($response_cover['msg']), 123);
                ...
                if ($Api_type == 'modification') {
                   ...
                   // print_r($response_cover);die;
                    if($response_cover['status'] != 0) {
                        ...
                        if ($response_cover['status'] == 201) {
                            $mail = sendMailCoverbalance($ceditor_email, $creaditor_name, $cover_limit, $cover_balance, $cover_collection_amt, $response_cover['msg']);
                            updatedailymail($creditor_id, 'status_cover');
                            echo $response_cover['msg'];
                            die;
                        } else {
                            if ($response_cover['msg'] == "LessCover") {
