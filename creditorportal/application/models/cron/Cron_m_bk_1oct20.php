	...
	public function createCRMLeadDropOff($emp_id) {
		...
		switch ($activityType) {
			...
			case 5:
				...
				break;	
			case 6:
				$activityStage = "at thank you pager";
				break;		
		}
		...
		$leadCreateArray = array(
						...
						"LEADREFERREDBY"=>"",
						"LEADREFERREDBYID"=>"",
						"LEADSTAGE"=>!empty($activityType) && $activityType == 6 ? "Payment DOne" : "Lead",
						"LEADSTATUS"=>"",
						"LEADTYPE"=>"Affinity",
						"LONGURL"=>$longUrl,
		...
		$request_arr = ["lead_id" => $empDetailsArray['lead_id'], "req" => $jsonData,"res" => json_encode($response) , "type"=>"CREATE_LEAD_CRM_JSON"];
		$this->db->insert("logs_docs",$request_arr);
