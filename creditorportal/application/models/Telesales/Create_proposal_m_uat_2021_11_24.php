				...
				foreach ($family_members_id as $key => $val) 
				{
					...
					if(empty($tempArr)){
						...
						foreach ($tempArr as $key1 => $value1) {
							...
							if($value1['fname'] == $first_name[$key] && $value1['lname'] == $last_name[$key] && $value1['dob'] == $family_date_birth[$key]){
